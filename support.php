...
<body is="dmx-app" id="brands">
    ...
    <dmx-serverconnect id="list_expenses" url="dmxConnect/api/servo_expenses/list_expenses.php" dmx-param:id="id" dmx-param:item_id="" dmx-param:user_id="" dmx-param:customer_id="session_variables.data.current_customer"></dmx-serverconnect>
    ...
    <dmx-serverconnect id="list_order_items" url="dmxConnect/api/servo_order_items/list_order_items_current.php" dmx-param:order_id="" noload></dmx-serverconnect>
                            ...
                            <div class="col">
                                ...
                                <div class="tab-content" id="navTabs1_content">
                                    <div class="tab-pane fade show active" id="navTabs1_111" role="tabpanel">
                                        <div class="row mt-2">
                                            <form id="createExpenseForm" is="dmx-serverconnect-form" method="post" action="dmxConnect/api/servo_expenses/create_expense.php" dmx-on:success="list_expenses.load({})">
                                                ...
                                                <div class="form-group mb-3 row" id="expenseAmount">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="expenseAmount1" name="expense_amount" aria-describedby="input1_help">
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3 row" id="expenseAmount2">
                                                    <label for="expenseAmount2" class="col-sm-2 col-form-label" wappler-command="editContent">{{trans.data.department[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <select id="expenseDepartment" class="form-select" name="expense_department" dmx-bind:options="list_departments.data.query_list_departments" optiontext="department_name" optionvalue="department_id">
                                        ...
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table class="table table-hover table-sm">
                                                    ...
                                                    <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_expenses.data.list_expenses" id="tableRepeat11">
                                                        <tr>
                                                            <td dmx-text="expense_amount"></td>
                            ...
                            <div class="col">
                                ...
                                <div class="tab-content" id="navTabs1_content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="row mt-2 ms-0">
                                                    ...
                                                    <div id="totalPayout" class="text-center mt-2 me-2 pt-4 pb-4 ps-4 pe-4 col" style="background: #b81f07 !important;">
                                                        <div class="row">
                                                            <div class="col">
                                                    ...
                                                    <div id="totalCovered" class="text-center mt-2 me-2 pt-4 pb-4 ps-4 pe-4 col" style="background: #176de0 !important;" dmx-hide="(read_customer.data.query_read_customer.customer_class == 'standard')">
                                                        <div class="row">
                                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between mt-2 justify-content-between">
                                                    ...
                                                    <div class="d-flex flex-sm-wrap col-md-5 justify-content-lg-end col-xl-6 justify-content-xl-end justify-content-xxl-end flex-wrap col-sm col-lg flex-lg-wrap flex-xl-wrap flex-xxl-wrap col">
                                                        <ul class="pagination" dmx-populate="list_customer_orders.data.query_list_customer_orders" dmx-state="listData" dmx-offset="customerOrdersOffset" dmx-generator="bs5paging">
                                                            <li class="page-item" dmx-class:disabled="list_customer_orders.data.query_list_customer_orders.page.current == 1" aria-label="First">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('customerOrdersOffset',list_customer_orders.data.query_list_customer_orders.page.offset.first)"><span aria-hidden="true">&lsaquo;&lsaquo;</span></a>
                                                            </li>
                                                            <li class="page-item" dmx-class:disabled="list_customer_orders.data.query_list_customer_orders.page.current == 1" aria-label="Previous">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('customerOrdersOffset',list_customer_orders.data.query_list_customer_orders.page.offset.prev)"><span aria-hidden="true">&lsaquo;</span></a>
                                                            </li>
                                                            <li class="page-item" dmx-class:active="title == list_customer_orders.data.query_list_customer_orders.page.current" dmx-class:disabled="!active" dmx-repeat="list_customer_orders.data.query_list_customer_orders.getServerConnectPagination(2,1,'...')">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('customerOrdersOffset',(page-1)*list_customer_orders.data.query_list_customer_orders.limit)">{{title}}</a>
                                                            </li>
                                                            <li class="page-item" dmx-class:disabled="list_customer_orders.data.query_list_customer_orders.page.current ==  list_customer_orders.data.query_list_customer_orders.page.total" aria-label="Next">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('customerOrdersOffset',list_customer_orders.data.query_list_customer_orders.page.offset.next)"><span aria-hidden="true">&rsaquo;</span></a>
                                                            </li>
                                                            <li class="page-item" dmx-class:disabled="list_customer_orders.data.query_list_customer_orders.page.current ==  list_customer_orders.data.query_list_customer_orders.page.total" aria-label="Last">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('customerOrdersOffset',list_customer_orders.data.query_list_customer_orders.page.offset.last)"><span aria-hidden="true">&rsaquo;&rsaquo;</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_2" role="tabpanel">
                                        <div class="row border rounded-2 border-secondary mt-2 ms-2 me-2 pt-3 pb-2">
                                            ...
                                            <form id="createCustomerTransaction" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_customer_cash_transactions/create_transaction.php" dmx-on:success="notifies1.success('Sucess!');createCustomerTransaction.reset();list_customer_transactions.load({customer_id: read_customer.data.query_read_customer.customer_id});list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_orders_totals.load({customer_id: session_variables.data.current_customer})" dmx-on:error="notifies1.danger('Error!')">
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto col-8 mb-2 col-sm-auto col-md-auto"><input id="transactionAmount1" name="transaction_amount" type="number" class="form-control ms-2" dmx-bind:placeholder="trans.data.amount[lang.value]" data-rule-number="" required="" data-msg-required="!" data-msg-number="!"></div>
                                                    ...
                                                    <div class="col-auto mb-2 col-sm-auto col-md-auto col-9"><select id="transactionType1" class="form-select ms-2" name="transaction_type" required="" data-msg-required="!">
                                                            <option value="Deposit">{{trans.data.deposit[lang.value]}}</option>
                                                            <option value="Payment">{{trans.data.payment[lang.value]}}</option>
                                                        </select></div>
                                                    <div class="col-auto mb-2 col-sm-auto col-md-auto"><select id="transactionPaymentMethod1" class="form-select ms-2" name="transaction_payment_method" dmx-bind:options="payment_methods.data.query" optiontext="payment_method_name" optionvalue="payment_method_id" required="" data-msg-required="!">
                                                            <option value="">----</option>
                                                        </select></div>
                                                    <div class="col-auto col-sm-auto col-md-auto mb-2 ms-1">
                        ...
                        <div class="container shadow-none" id="customerInvoiceContent">
                            ...
                            <div class="row justify-content-center row-cols-1" id="receiptInformation">
                                ...
                                <div class="col">
                                    ...
                                    <h5 class="text-info fw-bolder text-start" dmx-text="trans.data.coverage[lang.value]+' :  '+readCustomerOrder.data.order_coverage_partner.customer_first_name+' '+readCustomerOrder.data.order_coverage_partner.customer_last_name+' '+readCustomerOrder.data.order_coverage_partner.customer_phone_number" id="orderInsurer"></h5>
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button id="btn13" class="btn float-right btn-info" data-bs-target="#printInvoiceModal" dmx-on:click="printReceipt.show()" dmx-animate-enter.duration:20000.delay:100="pulse" dmx-class:show-print-2="(read_item_order.data.query.order_status == 'Paid')" data-bs-toggle="modal">
                            <i class="fas fa-print fa-2x"></i>
                        </button><button id="btn10" class="btn float-right ms-2 text-white btn-info" data-bs-toggle="offcanvas" data-bs-target="#AddProductsToOrderOffCanvas" dmx-on:click="" dmx-hide="(read_item_order.data.query.order_status == 'Paid')" style="/*color: #ffec66 !important;*/">
                            ...
                            <div class="offcanvas-body">
                                <div class="row scrollable row-cols-xxl-12 mt-2" id="productDisplay">
                                    <div class="col">
                                        <ul class="nav nav-tabs" id="navTabs1_tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="navTabs1_1_1tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_1_1" role="tab" aria-controls="navTabs1_1" aria-selected="true" wappler-command="editContent">{{trans.data.products[lang.value]}}</a>
                                            </li>
                                            <li class="nav-item visually-hidden">
                                                <a class="nav-link" id="navTabs1_3_tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_1_3" role="tab" aria-controls="navTabs1_3" aria-selected="false" wappler-command="editContent">{{trans.data.services[lang.value]}}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="navTabs1_2_2tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_2_2" role="tab" aria-controls="navTabs1_2" aria-selected="false" wappler-command="editContent">{{trans.data.grouped[lang.value]}}</a>
                                            </li>
                                        ...
                                        <div class="tab-content" id="navTabs1_1content">
                                            <div class="tab-pane fade show active" id="navTabs1_1_1" role="tabpanel">
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col"><button id="btn17" class="btn ms-2 me-2 btn-info" dmx-on:click="searchProducts1.setValue(null);load_products.load({service_id: list_user_shift_info.data.query_list_user_shift[0].servo_service_service_id})" wappler-empty="Editable" wappler-command="editContent">
                                                        ...
                                                        <form id="form3" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/create_order_item.php" dmx-on:success="form3.reset();list_order_items.load({order_id: session_variables.data.current_order});notifies1.success('Success:'+product_name+' Added to Order')" dmx-on:error="notifies1.danger('Error!')">
                                                            <div class="row mt-xxl-2 product-pic" id="productPic" dmx-hide="toggleProductPic.toggleProductPictures.checked">
                                                                <div class="col text-center" style="padding: 0px !important; height: 200px;" dmx-hide="product_picture==null">
                                                                    <img dmx-bind:src="'/servo/uploads/product_pictures/'+product_picture" width="100%" height="95%" loading="lazy" style="object-fit: cover;" wappler-command="updateImage">
                                                                </div>
                                                                <div class="col text-center" style="padding: 0px !important; height: 200px;" dmx-hide="product_picture!==null">
                                                                    <img width="100%" height="95%" loading="lazy" style="object-fit: cover;" src="uploads/servo_no_image2.jpg" wappler-command="updateImage">
                                                                </div>
                                                            </div>
                                                            <div class="row mt-2">
                                                                <div class="col d-flex justify-content-start">
                                                                    <h4 class="text-center fw-bold text-body" wappler-command="editContent">{{product_name}}</h4>
                                                                </div>
                                                                <div class="col d-flex justify-content-end">
                                                                    <h4 class="text-center text-body" wappler-command="editContent">{{product_price}}</h4>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row justify-content-between mb-2 text-center">
                                                                <div class="col-4">
                                                                    <button id="btn5" class="btn btn-lg btn-secondary text-light shadow" dmx-on:click="form3.inp_order_item_quantity.setValue((inp_order_item_quantity.value.toNumber()-1) )" wappler-empty="Editable" wappler-command="editContent"><i class="fas fa-minus"></i>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="col-4">
                                                                    <button id="btn16" class="btn btn-lg shadow btn-secondary text-light" dmx-on:click="form3.inp_order_item_quantity.setValue((inp_order_item_quantity.value.toNumber()+1) )" wappler-empty="Editable" wappler-command="editContent"><i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                            ...
                                                            <div class="row row-cols-xxl-7 mt-2 mt-sm-2 mt-md-2 mt-lg-2 mt-xl-2 mt-xxl-2" id="optionsrow">
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start">
                                                                    <div id="repeatOptions" is="dmx-repeat" dmx-bind:repeat="query_list_options">
                                                                        <button class="btn mb-xxl-2 me-xxl-2 button-repeat btn-info" dmx-text="category_option_option" dmx-bind:value="category_option_option" dmx-on:click="form3.inp_order_notes.setValue(form3.inp_order_notes.value+' '+optionsButton.value+' ')" id="optionsButton" wappler-command="editContent">Button</button>
                                                                    </div>
                                                            ...
                                                            <div class="row row-cols-xxl-7 justify-content-between mt-2 mb-2" id="buttons">
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start d-flex justify-content-start">
                                                                    ...
                                                                    <button id="btn8" class="add-item-button btn align-self-end btn-lg lh-1 text-muted" dmx-on:click="form3.inp_order_notes.setValue(null)" wappler-empty="Editable" wappler-command="editContent">
                                                                ...
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start d-flex justify-content-end">
                                                                    ...
                                                                    <button id="btn12" class="add-item-button btn btn-warning align-self-end btn-lg" type="submit" wappler-empty="Editable" wappler-command="editContent">
                                            ...
                                            <div class="tab-pane fade" id="navTabs1_2_2" role="tabpanel">
                                                <div class="row mt-md-1 mt-2">
                                                    <div class="flex-xxl-wrap border border-secondary col-md-4 mb-sm-2 me-sm-2 col-lg-3 col-xl-3 col-xxl-3 mt-xxl-0 mb-xxl-3 me-xxl-3 pt-xxl-3 pb-xxl-1 ps-xxl-1 pe-xxl-1 mb-1 me-1" dmx-repeat:repeatproductgroups="load_product_groups.data.repeat_list_product_groups">
                                                        <form id="form4" wappler-empty="Form" wappler-command="addElementInside"></form>
                                                        <div class="row mt-2">
                                                            <div class="col">
                                                                <h3 class="text-center text-warning" dmx-text="product_group_name" wappler-command="editContent"></h3>
                                                            </div>
                                                        </div>
                                                        <form id="addGroupedItemsToOrder" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_groups/add_grouped_products_to_order.php" dmx-on:success="form3.reset();list_order_items.load({order_id: session_variables.data.current_order});notifies1.success('Success:'+product_name+' Added to Order')">
                                                            ...
                                                            <div class="row row-cols-xxl-7 justify-content-between mt-2 mb-2" id="buttons1">
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start d-flex justify-content-end">
                                                                    ...
                                                                    <button id="btn14" class="add-item-button btn btn-warning align-self-end btn-lg" type="submit" wappler-empty="Editable" wappler-command="editContent">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                            ...
                                            <form is="dmx-serverconnect-form" id="updateOrderCashierStandard" method="post" action="dmxConnect/api/servo_orders/update_order_discount_note.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order});readCustomerOrder.load({order_id: session_variables.data.current_order})">
                                                ...
                                                <div class="row mt-2 mb-3">
                                                    ...
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-warning me-md-1 pt-md-2 pb-md-2 ps-md-2 pe-md-2 me-2 bg-info" dmx-bind:value="read_item_order.data.query.Save" type="submit" dmx-hide="(read_item_order.data.query.order_status == 'Paid')">
                                                            <i class="fas fa-check fa-2x"></i>
                                                        </button>
                                                    </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        </div><button id="btn22" class="btn float-right text-warning ms-4 visually-hidden" data-bs-target="#printInvoiceModal" dmx-on:click="printReceipt.show()" dmx-animate-enter.duration:20000.delay:100="pulse" dmx-class:show-print-2="(read_item_order.data.query.order_status == 'Paid')" data-bs-toggle="modal">
                            <i class="fas fa-receipt fa-2x" style="color: #189aff !important;"></i>
                        </button>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        ...
        <div class="container mt-auto">
            ...
            <div class="row servo-page-header">
                ...
                <div class="col-auto page-heading">
                    <h4 class="servo-page-heading">{{trans.data.customerSupport[lang.value]}}</h4>
                </div>
                <div class="col style13 page-button d-flex justify-content-end" id="pagebuttons">
                    <button id="btn11" class="btn text-info" data-bs-toggle="modal" data-bs-target="#expenseModal">
                        <i class="fas fa-cash-register fa-2x"></i>
                    </button>
                    <div id="conditional1" is="dmx-if" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].create_customer == 'Yes')"><button id="btn1" class="btn style12 fw-light add-button text-white" data-bs-toggle="modal" data-bs-target="#createItemModal" style="float: right;"><i class="fas fa-user-plus fa-2x"></i>
                        </button></div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between justify-content-between sorter mt-2 mb-2 ms-0 me-0 shadow-none">
