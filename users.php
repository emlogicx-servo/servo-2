            ...
            <div class="row">
              <form is="dmx-serverconnect-form" id="serverconnectFormCreateUser" method="post" action="dmxConnect/api/servo_users/create_user.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-on:success="notifies1.success('Success');serverconnectListUsers.load();serverconnectFormCreateUser.reset();createItemModal.hide()" dmx-on:submit="">
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inp_user_fname" name="user_fname" aria-describedby="inp_user_fname_help" placeholder="Enter First Name">
                  </div>
                </div>
                <div class="mb-3 row">
                  <label for="inp_user_lname" class="col-sm-2 col-form-label">{{trans.data.surname[lang.value]}}</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inp_user_lname" name="user_lname" aria-describedby="inp_user_lname_help" placeholder="Enter Last Name">
                  </div>
                </div>
                <div class="mb-3 row">
                  <label for="inp_user_username" class="col-sm-2 col-form-label">{{trans.data.username[lang.value]}}</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inp_user_username" name="user_username" aria-describedby="inp_user_username_help" placeholder="Enter Username" data-rule-nowhitespace="" data-msg-nowhitespace="Error!">
                  </div>
                </div>
                <div class="mb-3 row">
                  <label for="inp_pasword" class="col-sm-2 col-form-label">{{trans.data.password[lang.value]}}</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="inp_pasword" name="password" aria-describedby="inp_pasword_help" placeholder="Enter Password">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  <label for="department" class="col-sm-2 col-form-label">{{trans.data.department[lang.value]}}</label>
                  <div class="col-sm-10">
                    <select id="select2" class="form-select" dmx-bind:options="load_user_departments.data.query" optiontext="department_name" optionvalue="department_id" name="servo_user_departments_department_id">
                    </select>
                  </div>
                  <div class="col-sm-10">
          ...
          <div class="modal-body">
            ...
            <form is="dmx-serverconnect-form" id="readitem" method="post" action="dmxConnect/api/servo_users/update_user.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_user.data.query" dmx-on:success="notifies1.success('Success');serverconnectListUsers.load();readItemModal.hide()">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <select id="select4" class="form-select" dmx-bind:options="load_user_departments.data.query" optiontext="department_name" optionvalue="department_id" dmx-bind:value="read_item_user.data.query.servo_user_departments_department_id" name="servo_user_departments_department_id">
                  </select>
                </div>
              </div>
              <div class="mb-3 row">
    ...
    <div class="mt-2 ms-2 me-2">
      ...
      <div class="row servo-page-header">
        ...
        <div class="col-auto page-heading">
          <h5 class="servo-page-heading">{{trans.data.users[lang.value]}}</h5>
        </div>
        <div class="col style13 page-button" id="pagebuttons">
          <button id="btn1" class="btn style12 fw-light add-button w-auto text-body bg-light  rounded" data-bs-toggle="modal" data-bs-target="#createItemModal" style="float: right;"><i class="fas fa-plus"></i>
          </button>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between justify-content-between mt-2 mb-2 sorter h-auto rounded bg-light">
            <div class="col-lg-3 h-auto col-sm-4 col-xxl-2 col-6"><input id="userfilter" name="userfilter" type="text" class="form-control mb-2 form-control-sm" dmx-bind:placeholder="trans.data.search[lang.value]+'  '"></div>

            <div class="d-flex flex-sm-wrap col-md-5 col-lg-7 col-xl-6 flex-wrap col-sm col-6">
      ...
      <div class="row">
        <div class="col ms-3 me-3 rounded scrollable bg-light">
