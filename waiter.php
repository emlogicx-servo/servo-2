                  ...
                  <div class="row">
                    <div class="col d-flex justify-content-center ms-1 me-1 flex-wrap">
                      <form is="dmx-serverconnect-form" id="create_order_form" method="post" action="dmxConnect/api/servo_orders/create_order.php" dmx-on:success="notifies1.success('Order #'+create_order_form.data.custom[0]['last_insert_id()']+' Created');session_variables.set('current_order',create_order_form.data.custom[0]['last_insert_id()']);CreateOrderModal.hide();list_orders.load();create_order_form.reset();read_item_order.load({order_id: create_order_form.data.query_insert_order.identity});readItemModal.show();list_order_items.load({order_id: create_order_form.data.query_insert_order.identity})">
                        ...
                        <input id="orderCustomer" name="order_customer" type="hidden" class="form-control visually-hidden" dmx-bind:value="list_user_shift_info.data.query_list_user_shift[0].customer_id">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ms-1 me-1">
            <div class="offcanvas offcanvas-start" id="AddProductsToOrderOffCanvas" is="dmx-bs5-offcanvas" tabindex="-1" style="width: 99%;">
              <div class="offcanvas-header">
                <div class="d-block">
                  <h2 class="offcanvas-title fw-bolder text-body">{{trans.data.products[lang.value]}}</h2>
                </div>
                        ...
                        <div class="row mt-2 ms-1 me-1 mt-sm-1 ms-sm-1 me-sm-1 mt-md-1 ms-md-1 me-md-1 mt-lg-1 ms-lg-1 me-lg-1 mt-xxl-1 ms-xxl-1 me-xxl-1 mt-xl-1 me-xl-1 row-cols-xxl-12 row-cols-lg-10 row-cols-xl-12 row-cols-md-3">
                          ...
                          <div class="border-dark mb-2 ms-1 me-1 pt-3 pb-3 ps-3 pe-3 rounded-bottom col-xxl-auto bg-primary bg-opacity-10 col-auto offset-md-0 col-sm-auto col-lg-auto col-xl-auto col-md-auto" dmx-repeat:repeatproducts="load_products.data.repeat" style="padding-top: 0px !important;">
                            <form id="addItem2" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/create_order_item.php" dmx-on:success="addItem2.reset();list_order_items.load({order_id: session_variables.data.current_order});notifies1.success('Success:'+product_name+' Added to Order')">
                              ...
                              <div class="row row-cols-2 justify-content-between mt-lg-2 mt-xl-2 mt-xxl-2 mt-md-2 mt-sm-2 mt-2">
                                <div class="col d-flex justify-content-start">
                                  <h5 class="text-center fw-bold text-body">{{product_name}}</h5>
                                </div>
                                <div class="col d-flex justify-content-end">
                                  <h6 class="text-center fw-bold text-danger bg-opacity-10 rounded pt-1 pb-1 ps-2 pe-2">{{product_price.formatNumber('O',',',',')}}</h6>
                                </div>
                              </div>
                              ...
                              <div class="row row-cols-xxl-7 mt-lg-2 mt-2 mt-sm-2 mt-md-2 mt-xl-2 mt-xxl-2 row-cols-12 justify-content-xxl-start justify-content-xl-start justify-content-lg-start" id="optionsrow1" style="">
                                <div class="col w-25  d-flex flex-md-nowrap flex-md-row justify-content-md-start col-md flex-xxl-nowrap justify-content-xxl-start flex-xxl-row flex-xl-nowrap justify-content-xl-start flex-xl-row flex-lg-nowrap justify-content-lg-start flex-lg-row flex-sm-nowrap justify-content-sm-start flex-sm-row flex-nowrap justify-content-start flex-row col-xxl col-xl col-lg" style="">
                              ...
                              <div class="row row-cols-xxl-7 mt-2 mb-2 justify-content-lg-between row-cols-lg-6 row-cols-7 justify-content-between" id="buttons2" style="">

                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start col-lg d-flex justify-content-start">
                                ...
                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start col-lg">
            ...
            <div class="row row-cols-2 justify-content-between">
              ...
              <div class="d-flex col-auto">
                <h6 class="fw-bold rounded me-2 pt-2 pb-2 ps-3 pe-3 text-info bg-info bg-opacity-10"><i class="fas fa-receipt fa-sm" style="margin-right: 3px"></i>
                  {{read_item_order.data.query.order_id}}</h6>
                <h6 class="fw-bold rounded me-2 pt-2 pb-2 ps-3 pe-3 bg-info bg-opacity-10 text-info"><i class="fas fa-map-marker-alt" style="margin-right: 3px"></i>{{read_item_order.data.query.table_name}}&nbsp;</h6>
    ...
    <div class="ms-2 me-2">
      ...
      <div class="row servo-page-header rounded mt-2 pt-2 pb-2">
        <div class="style13 page-button justify-content-sm-end top-bar text-light col-auto" id="pagebuttons">
          <h5 class="text-start fw-bolder bg-opacity-10 pt-2 pb-2 ps-3 pe-3 rounded text-primary bg-primary">
