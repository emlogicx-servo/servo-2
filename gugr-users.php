...
$app->exec(<<<'JSON'
{
	"steps": [
		...
		"SecurityProviders/servo_login",
		{
			"module": "auth",
			"action": "restrict",
			"options": {"permissions":"gugr-admin","loginUrl":"login.php","forbiddenUrl":"login.php","provider":"servo_login"}
		}
	]
}
JSON
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <select id="select5" class="form-select" name="user_profile">
                      <option value="gugr-admin">{{trans.data.Admin[lang.value]}}</option>
                      <option value="gugr-cordo">{{trans.data.cordo[lang.value]}}</option>
                      <option value="gugr-reception">{{trans.data.reception[lang.value]}}</option>
                      <option value="gugr-personnel">{{trans.data.personnel[lang.value]}}</option>
                    </select>
                  </div>
                </div>
                <div class="mb-3 row">
    ...
    <div class="container mt-auto">
      ...
      <div class="row servo-page-header">
        <div class="col-auto" dmx-animate-enter="slideInLeft">
          <i class="fas fa-user-check fa-2x" style="color: #ffcd74 !important;"></i>
        </div>
        <div class="col-auto page-heading">
          <h4 class="servo-page-heading">{{trans.data.users[lang.value]}}</h4>
        </div>
        <div class="col style13 page-button" id="pagebuttons">
          <button id="btn1" class="btn style12 fw-light add-button" data-bs-toggle="modal" data-bs-target="#createItemModal" style="float: right;"><i class="fas fa-plus fa-2x"></i>
          </button>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between justify-content-between mt-2 mb-2 sorter h-auto bg-light shadow-none">
            <div class="col-lg-3 h-auto col-12 col-sm-12"><input id="userfilter" name="userfilter" type="text" class="form-control mb-2 form-control-sm" dmx-bind:placeholder="trans.data.search[lang.value]+'  '" style="/* background:  */"></div>
          ...
          <div class="table-responsive servo-shadow bg-light scrollable">
