    ...
    "steps": {
      ...
      "options": {
        ...
        "sql": {
          ...
          "query": "SELECT *\nFROM servo_order_items\nINNER JOIN servo_products ON (servo_products.product_id = servo_order_items.servo_products_product_id) INNER JOIN servo_orders ON (servo_orders.order_id = servo_order_items.servo_orders_order_id) INNER JOIN servo_customer_table ON (servo_customer_table.table_id = servo_orders.servo_customer_table_table_id)\nWHERE servo_order_items.servo_orders_order_id = 0",
          "params": []
        }
      },
      "output": true,
