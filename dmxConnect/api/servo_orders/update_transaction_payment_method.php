    ...
    "steps": {
      ...
      "options": {
        ...
        "sql": {
          ...
          "query": "UPDATE servo_orders\nSET servo_customer_table_table_id = :P1 /* {{$_POST.servo_customer_table_table_id}} */, order_notes = :P2 /* {{$_POST.order_notes}} */, order_customer = :P3 /* {{$_POST.order_customer}} */, order_discount = :P4 /* {{$_POST.order_discount}} */\nWHERE order_id = :P5 /* {{$_POST.order_id}} */",
          "params": [
            {
              "name": ":P1",
              "type": "expression",
