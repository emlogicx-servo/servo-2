...
$app->define(<<<'JSON'
{
  ...
  "exec": {
    "steps": {
      "name": "list_wallet_transactions_paged_deletes",
      "module": "dbconnector",
      "action": "paged",
      "options": {
        "connection": "servodb",
