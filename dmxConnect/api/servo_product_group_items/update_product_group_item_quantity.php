...
$app->define(<<<'JSON'
{
  ...
  "exec": {
    "steps": {
      "name": "update_product_group_item_quantity",
      "module": "dbupdater",
      "action": "update",
      "options": {
        "connection": "servodb",
        "sql": {
          ...
          "query": "UPDATE servo_product_group_items\nSET product_group_product_quantity = :P1 /* {{$_POST.product_group_product_quantity}} */, product_group_item_id = :P2 /* {{$_POST.product_group_item_id}} */\nWHERE product_group_item_id = :P3 /* {{$_POST.product_group_item_id}} */",
          "params": [
            {
              "name": ":P1",
              "type": "expression",
