    ...
    "steps": {
      ...
      "options": {
        ...
        "sql": {
          ...
          "query": "UPDATE servo_profile_settings\nSET profile_settings_id = :P1 /* {{$_POST.profile_settings_id}} */, delete_order_item = :P2 /* {{$_POST.delete_order_item}} */\nWHERE profile_settings_id = :P3 /* {{$_POST.profile_settings_id}} */",
          "params": [
            {
              "name": ":P1",
              "type": "expression",
