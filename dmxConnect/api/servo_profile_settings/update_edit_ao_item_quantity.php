...
$app->define(<<<'JSON'
{
  ...
  "exec": {
    "steps": {
      "name": "update_edit_ao_item_quantity",
      "module": "dbupdater",
      "action": "update",
      "options": {
        "connection": "servodb",
        "sql": {
          ...
          "values": [
            ...
            },
            {
              ...
              "type": "text",
              "value": "{{$_POST.edit_ao_item_quantity}}"
            }
          ],
          "table": "servo_profile_settings",
          "wheres": {
          ...
          "query": "UPDATE servo_profile_settings\nSET profile_settings_id = :P1 /* {{$_POST.profile_settings_id}} */, edit_ao_item_quantity = :P2 /* {{$_POST.edit_ao_item_quantity}} */\nWHERE profile_settings_id = :P3 /* {{$_POST.profile_settings_id}} */",
          "params": [
            {
              "name": ":P1",
              "type": "expression",
