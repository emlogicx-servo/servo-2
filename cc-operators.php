...
<body is="dmx-app" id="operators">
    ...
    <dmx-query-manager id="listCustomerAssets"></dmx-query-manager>
    ...
    <dmx-serverconnect id="list_customer_files" url="dmxConnect/api/servo_files/list_files.php" dmx-param:id="id" dmx-param:customer_id="session_variables.data.current_customer" dmx-param:offset="listCustomerOrders.data.customerOrdersOffset" dmx-param:limit="c_order_sort_limit.value"></dmx-serverconnect>
    ...
    <dmx-serverconnect id="list_customer_data_reading_sessions" url="dmxConnect/api/servo_data_reading_session/list_data_reading_sessions_customer.php" dmx-param:id="id" dmx-param:customer_id="read_customer.data.query_read_customer.customer_id" dmx-param:offset="listData.data.listCustomerDataOffset" dmx-param:limit="dataFilterSort.selectedValue"></dmx-serverconnect>
    ...
    <dmx-serverconnect id="list_customer_assets" url="dmxConnect/api/servo_assets/list_customer_assets_paged.php" dmx-param:id="id" dmx-param:customer_id="session_variables.data.current_customer" dmx-param:offset="listCustomerOrders.data.offset" dmx-param:limit="c_order_sort_limit.value" dmx-param:data_reading_session_id="read_customer_data_reading_sessions.data.query_read_data_reading_session.data_reading_session_id" dmx-param:customer="read_customer.data.query_read_customer.customer_id"></dmx-serverconnect>
    ...
    <dmx-serverconnect id="read_customer_asset" url="dmxConnect/api/servo_assets/read_customer_asset.php" dmx-param:id="id" noload="" dmx-param:customer_id="session_variables.data.current_customer" dmx-param:offset="listCustomerOrders.data.offset" dmx-param:limit="c_order_sort_limit.value" dmx-param:data_reading_session_id="data_reading_session_id"></dmx-serverconnect>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{trans.data.newOperator[lang.value]}}</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form is="dmx-serverconnect-form" id="serverconnectFormCreateUser" method="post" action="dmxConnect/api/servo_customers/create_customer_operator.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-on:success="notifies1.success('Success!');list_customers.load();serverconnectFormCreateUser.reset()">
                                ...
                                <div class="mb-3 row">
                                    <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.taxPayerNumber[lang.value]}}</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="taxPayerNumber" name="customer_tax_payer_number" aria-describedby="inp_customer_phone_number_help">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.email[lang.value]}}</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="customerEmail" name="customer_email" aria-describedby="inp_customer_phone_number_help">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="customerLegalStatus" name="customer_legal_status" aria-describedby="inp_customer_phone_number_help">
                                    </div>
                                </div>
                                <div class="row">
                                    <h3>{{trans.data.repInfo[lang.value]}}</h3>
                                </div>
                                <div class="mb-3 row">
                                    <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.name[lang.value]}}</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="repName" name="customer_rep_name" aria-describedby="inp_customer_phone_number_help">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.surname[lang.value]}}</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="repSurname" name="customer_rep_surname" aria-describedby="inp_customer_phone_number_help">
                                    </div>
                                </div>
                                <div class="mb-3 row">
    ...
    <main id="createAsset">
        <div class="modal create-modal" id="createAssetModal" is="dmx-bs5-modal" tabindex="-1" style="z-index: 100000000;" dmx-on:hide-bs-modal="readItemModal.show()">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{trans.data.createProject[lang.value]}}</h5>
                            ...
                            <div class="col">
                                <ul class="nav nav-tabs nav-justified" id="navTabs1_tabs" role="tablist">
                                    <li class="nav-item visually-hidden">
                                        <a class="nav-link" id="navTabs1_1_tab1" data-bs-toggle="tab" href="#" data-bs-target="#tabPane1" role="tab" aria-controls="navTabs1_1" aria-selected="true" dmx-on:click="list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_orders_totals.load({customer_id: session_variables.data.current_customer})">{{trans.data.overview[lang.value]}}</a>
                                    </li>
                                    <li class="nav-item visually-hidden">
                                ...
                                <div class="tab-content" id="navTabs1_content">
                                    <div class="tab-pane visually-hidden" id="tabPane1" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="row mt-2 ms-0">
                                                    ...
                                                    <div class="bg-info text-center mt-2 me-2 pt-4 pb-4 ps-4 pe-4 col" id="totalDeposits" style="background: #ff2afa !important;">
                                                        <div class="row">
                                                            <div class="col">
                                                    ...
                                                    <div id="totalSettlements" class="bg-info text-center mt-2 me-2 pt-4 pb-4 ps-4 pe-4 col" style="background: #07b853 !important;">
                                                        <div class="row">
                                                            <div class="col">
                                    ...
                                    <div class="tab-pane fade visually-hidden" id="navTabs1_1" role="tabpanel">
                                        <div class="row mt-2">
                                            <div class="col">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_customer_orders.data.query_list_customer_orders.data" id="tableRepeat3">
                                                            <tr>
                                                                ...
                                                                <td wappler-command="editContent">
                                                                    <h6 dmx-text="trans.data.getValueOrKey(order_status)[lang.value]" dmx-class:yellow-state="(order_status == 'Ordered')" dmx-class:green-state="(order_status == 'Paid')" dmx-class:grey-state="(order_status == 'Pending')" dmx-class:red-state="(order_status == 'Credit')" class="text-center pt-1 pb-1 ps-2 pe-2"></h6>
                                    ...
                                    <div class="tab-pane fade visually-hidden" id="navTabs1_8" role="tabpanel" dmx-hide="(read_customer.data.query_read_customer.customer_class == 'standard')">
                                        <div class="row mt-2">
                                            <div class="col">
                                                <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between mt-2 justify-content-between">
                                    ...
                                    <div class="tab-pane fade visually-hidden" id="navTabs1_2" role="tabpanel">
                                        <div class="row mt-2">
                                                    ...
                                                    <table class="table table-hover table-sm">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_customer_transactions.data.query" id="tableRepeat2">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="row" is="dmx-if" id="conditional6" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].delete_order == 'Yes')">
                                    ...
                                    <div class="tab-pane fade visually-hidden" id="navTabs1_6" role="tabpanel">
                                        <div class="row mt-2">
                                            <div class="col">
                                                <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between mt-2 justify-content-between">
                                                    ...
                                                    <div class="d-flex flex-sm-wrap col-md-5 justify-content-lg-end col-xl-6 justify-content-xl-end justify-content-xxl-end flex-wrap col-sm col-lg flex-lg-wrap flex-xl-wrap flex-xxl-wrap col">
                                                        <ul class="pagination" dmx-populate="list_customer_data_reading_sessions.data.query_list_data_reading_sessions" dmx-state="listData" dmx-offset="listCustomerDataOffset" dmx-generator="bs5paging">
                                                            <li class="page-item" dmx-class:disabled="list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.current == 1" aria-label="First">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('listCustomerDataOffset',list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.offset.first)"><span aria-hidden="true">&lsaquo;&lsaquo;</span></a>
                                                            </li>
                                                            <li class="page-item" dmx-class:disabled="list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.current == 1" aria-label="Previous">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('listCustomerDataOffset',list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.offset.prev)"><span aria-hidden="true">&lsaquo;</span></a>
                                                            </li>
                                                            ...
                                                            <li class="page-item" dmx-class:disabled="list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.current ==  list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.total" aria-label="Next">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('listCustomerDataOffset',list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.offset.next)"><span aria-hidden="true">&rsaquo;</span></a>
                                                            </li>
                                                            <li class="page-item" dmx-class:disabled="list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.current ==  list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.total" aria-label="Last">
                                                                <a href="javascript:void(0)" class="page-link" dmx-on:click="listData.set('listCustomerDataOffset',list_customer_data_reading_sessions.data.query_list_data_reading_sessions.page.offset.last)"><span aria-hidden="true">&rsaquo;&rsaquo;</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-1 col-xl-1 col-md-2 col-sm-2 offset-lg-1 col-3"><select id="dataFilterSort" class="form-select" name="dataFilterSort" dmx-on:updated="list_customer_data_reading_sessions.load({limit: dataFilterSort.selectedValue, offset: listData.data.listCustomerDataOffset, customer_id: read_customer.data.query_read_customer.customer_id})">
                                                            <option value="5">5</option>
                                                            <option selected="" value="25">25</option>
                                                            <option value="50">50</option>
                                                            <option value="100">100</option>
                                    ...
                                    <div class="tab-pane fade active show" id="navTabs1_11" role="tabpanel">
                                        <div class="row mt-2">
                                            <div class="col">
                                                <div class="row justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between mt-2 justify-content-between">
                                                    <div class="col-lg-3 col-12 col-sm d-flex flex-sm-wrap col-sm-12"><input id="customerorderfilter3" name="customerorderfilter3" type="text" class="form-control mb-2 form-control-sm" dmx-bind:placeholder="trans.data.search[lang.value]+'  '"></div>
                                                    ...
                                                    <div class="col-lg-1 col-xl-1 col-md-2 col-sm-2 offset-lg-1 col-3"><select id="dataFilterSort1" class="form-select" name="dataFilterSort1" dmx-on:updated="list_customer_data_reading_sessions.load({limit: dataFilterSort.selectedValue, offset: listData.data.listCustomerDataOffset, customer_id: read_customer.data.query_read_customer.customer_id})">
                                                            <option value="5">5</option>
                                                            <option selected="" value="25">25</option>
                                                            <option value="50">50</option>
                                                            <option value="100">100</option>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-sm">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_customer_assets.data.list_customer_assets_paged.data" id="tableCustomerAssets">
                                                            <tr>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_3" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="pt-2 pb-2 col-xl-4 col-lg-6 col-12 text-sm-center text-center col-md-6 text-md-center"><img dmx-bind:src="'/servo/uploads/customer_pictures/'+read_customer.data.query_read_customer.customer_picture" class="img-fluid" dmx-hide="(read_customer.data.query_read_customer.customer_picture == null)" loading="lazy" style="object-fit: cover; height: 300px; width: 300px; border-radius: 50%;">
                                            ...
                                            <div class="col">
                                                <form is="dmx-serverconnect-form" id="readitem" method="post" action="dmxConnect/api/servo_customers/update_customer.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_customer.data.query_read_customer" dmx-on:success="list_customers.load({});list_customers_special.load();notifies1.success('Success!')" dmx-on:error="notifies1.warning('Error!')" dmx-on:submit="">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control" id="customerphonenumber1" name="customer_phone_number" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_phone_number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.idCardNumber[lang.value]}}</label>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="taxPayerNumber1" name="customer_tax_payer_number" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_tax_payer_number">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.email[lang.value]}}</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="customerEmail1" name="customer_email" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_email">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.legalStatus[lang.value]}}</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="customerLegalStatus1" name="customer_legal_status" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_legal_status">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="repName1" name="customer_rep_name" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_rep_name">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.surname[lang.value]}}</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="repSurname1" name="customer_rep_surname" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_rep_surname">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.idCardNumber[lang.value]}}</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="repID1" name="customer_rep_id_card" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_rep_id_card">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label">{{trans.data.address[lang.value]}}</label>
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label for="inp_customer_phone_number1" class="col-sm-2 col-form-label" id="repPhone">{{trans.data.phoneNumber[lang.value]}}</label>

                                                        <div class="col-sm-10">
                                                            <input class="form-control" id="repPhone1" name="customer_rep_phone" aria-describedby="inp_customer_phone_number_help" dmx-bind:value="read_customer.data.query_read_customer.customer_rep_phone">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_31" role="tabpanel">
                                        <div class="row justify-content-xxl-end row-cols-xxl-12 row-cols-12 mt-3 mb-2 justify-content-end">
                                            <div class="col text-end"><button id="btn41" class="btn btn-info w-auto text-white" dmx-on:click="" data-bs-toggle="collapse" data-bs-target="#uploadFileCollapse"><i class="fas fa-file-upload"></i>
                                                </button></div>
                                        </div>
                                            ...
                                            <div class="container">
                                                <div class="row mt-xl-3 mt-3">
                                                    <div class="col mt-md-3 ms-lg-2 me-lg-2 ms-2 me-2 pt-2 pb-2 ps-5 pe-2 rounded rounded-2 bg-secondary">
                                                        ...
                                                        <form id="form6"></form>
                                                        <form id="uploadFile" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_files/create_file.php" dmx-on:success="uploadFileCollapse.hide();list_customer_files.load({customer_id: read_customer.data.query_read_customer.customer_id});uploadFile.reset();notifies1.success('Success!')" dmx-on:error="notifies1.warning('Error!')">
                                                            <input id="fileUserCreated" name="file_user_created" type="text" class="form-control visually-hidden" dmx-bind:value="list_user_info.data.query_list_user_info.user_id">
                                                            ...
                                                            <input id="file_customer_id" name="file_customer_id" type="number" class="form-control visually-hidden" dmx-bind:value="read_customer.data.query_read_customer.customer_id">
                                                            <input id="fileName" name="file_name" type="number" class="form-control visually-hidden" dmx-bind:value="uploadFile.file.file.name">



                                                            <div class="form-group mb-3 row">
                                                                <label for="file" class="col-sm-2 col-form-label col-lg-2" wappler-command="editContent">{{trans.data.uploadFileCollapse.lang.value]}}</label>
                                                                <div class="col-sm-10 offset-md-4 col-lg-5 offset-lg-1">
                                                                    <input id="customerFile" name="file_name" class="form-control visually-hidden"><input type="file" class="form-control" id="file" name="file" aria-describedby="input1_help" data-rule-maxtotalsize="2000000000" data-msg-maxtotalsize="Max 100MB!" required="" data-msg-required="!">
                                                                </div>
                                                            </div>
                                                            <div class="form-group mb-3 row" id="fileType">
                                                                <label for="fileType" class="col-sm-2 col-form-label col-md col-lg-2" wappler-command="editContent">{{trans.data.description[lang.value]}}</label>
                                                                <div class="col-sm-10 col-md-8 offset-lg-1">
                                                                    <textarea id="fileDescription" name="file_description" type="text" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <div class="table-responsive">
                                                    <table class="table table-sm">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_customer_files.data.query_list_customer_files" id="tableRepeat1">
                                                            <tr>
                                                                <td dmx-text="file_id" wappler-command="editContent"></td>
                                                                <td dmx-text="file_name" wappler-command="editContent"></td>
                                                                ...
                                                                <td dmx-text="file_date_created" wappler-command="editContent"></td>
                                                                <td wappler-command="editContent" dmx-on:click="">
                                                                    <a href="" dmx-bind:href="'uploads/files/'+file_name" dmx-bind:download="file_name"><button id="btn58" class="btn text-info" type="submit"><i class="fas fa-download fa-lg"></i>
                                                                        </button></a>


                                                                </td>
                                                                <td onclick="window.alert('Confirm Delete!')">
                                                                    <form id="deleteFile" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_files/delete_file.php" dmx-on:success="list_customer_files.load({customer_id: read_customer.data.query_read_customer.customer_id})"><input id="file1" name="file_name" type="text" class="form-control visually-hidden" dmx-bind:value="file_name">
                                                                        <input id="fileId" name="file_id" type="text" class="form-control visually-hidden" dmx-bind:value="file_id">
                                                                        <button id="deleteFile." class="btn text-secondary" type="submit"><i class="far fa-trash-alt fa-lg"></i>
                                                                        </button>
                                                                    </form>
                                                                </td>
                                                            </tr>
                        ...
                        <div class="container shadow-none" id="customerInvoiceContent">
                            ...
                            <div class="row" style="color: black !important;">
                                ...
                                <div class="col border" style="">
                                    <div class="row">
                                        <div class="justify-content-xl-end col-xl-auto col-auto" id="coverageToPay1">
                                            <h6 class="ms-2 pt-2">{{trans.data.coverageTotal[lang.value]}}:</h6>
                                        </div>
                                        <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2" id="coverageToPayAmount1">
                                    ...
                                    <div class="row">
                                        <div class="justify-content-xl-end col-xl-auto col-auto" id="toPay1">
                                            <h6 class="ms-2 pt-2">{{trans.data.customerTotal[lang.value]}}:</h6>
                                        </div>
                                        <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 h-50" id="toPayAmount1">
    ...
    <main id="customerOrder">
        <div class="modal readitem shadow" id="customerOrderModal" is="dmx-bs5-modal" tabindex="-1" dmx-on:hidden-bs-modal="total_sales_per_waiter.load();updateOrderCashier.reset();readCustomerOrder.load({order_id: session_variables.data.current_order});list_customer_orders.load({}); readItemModal.show();list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_orders_totals.load({customer_id: readCustomerOrder.data.query.order_customer})">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <main>
                                <div class="row justify-content-start justify-content-xxl-start justify-content-lg-start justify-content-md-start justify-content-sm-start justify-content-xl-start row-cols-xl-7 rounded-pill">
                                    <div class="d-flex col-xl-auto rounded rounded-3 col-auto">
                                        <h4 class="text-light">{{trans.data.order[lang.value]}}</h4>
                                    </div>
                                    <div class="d-flex col-xl-auto rounded rounded-3 col-auto">
                                        <h4 class="text-light" dmx-text="readCustomerOrder.data.query.order_id"></h4>
                                    </div>
                        ...
                        <form id="close_order" is="dmx-serverconnect-form" method="post" action="dmxConnect/api/servo_orders/close_customer_order.php" dmx-on:success="notifies1.success('Success!');list_customer_orders.load({customer_id: session_variables.data.current_customer, offset: listCustomerOrders.data.offset, limit: c_order_sort_limit.value});list_order_items.load({order_id: session_variables.data.current_order});readCustomerOrder.load({order_id: session_variables.data.current_order})">
                            ...
                            <button id="btn18" class="btn float-right text-danger" data-bs-target="#AddProductsToOrderOffCanvas" dmx-show="(variableCustomerTotalToPay.value >='0')" style="color: #9bff66 !important;" type="submit" dmx-bind:disabled="(readCustomerOrder.data.query.order_status == 'Paid')">
                                    ...
                                    <div class="tab-pane fade show active" id="navTabs1_13" role="tabpanel">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="row" is="dmx-if" id="conditional8" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].delete_order_item == 'Yes')">
                                                                        <form id="form2" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/delete_order_item.php" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order})" dmx-class:hidethis="" onsubmit=" return confirm('CONFIRM DELETE?');">
                                        ...
                                        <div class="row" id="orderUpdate">
                                            <form is="dmx-serverconnect-form" id="updateOrderCashierStandard" method="post" action="dmxConnect/api/servo_orders/update_order_discount_note.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order});readCustomerOrder.load({order_id: session_variables.data.current_order})">
                                                ...
                                                <div class="row">
                                                    <label for="inp_order_notes3" class="col-sm-2 col-form-label">{{trans.data.discount[lang.value]}}</label>
                                                ...
                                                <div class="row mt-2 mb-3">
                                                    ...
                                                    <label for="inp_order_notes3" class="col-sm-2 col-form-label"></label>
    ...
    <main id="customerAsset">
        <div class="modal readitem shadow" id="customerAssetModal" is="dmx-bs5-modal" tabindex="-1" dmx-on:hidden-bs-modal="total_sales_per_waiter.load();updateOrderCashier.reset();readCustomerOrder.load({order_id: session_variables.data.current_order});list_customer_orders.load({}); readItemModal.show();list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_orders_totals.load({customer_id: readCustomerOrder.data.query.order_customer})">
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        </div><button id="btn25" class="btn float-right text-warning ms-4" data-bs-target="#printInvoiceModal" dmx-on:click="printReceipt.show()" dmx-animate-enter.duration:20000.delay:100="pulse" dmx-class:show-print-2="(read_item_order.data.query.order_status == 'Paid')" data-bs-toggle="modal">
                            <i class="fas fa-receipt fa-2x" style="color: #189aff !important;"></i>
                        </button><button id="btn25" class="btn text-success float-right" data-bs-toggle="offcanvas" data-bs-target="#AddProductsToOrderOffCanvas" dmx-on:click="" dmx-hide="(read_item_order.data.query.order_status == 'Paid')" style="color: #ffec66 !important;">
                            <i class="fas fa-plus fa-2x"></i>
                        </button>
                        <form id="close_order1" is="dmx-serverconnect-form" method="post" action="dmxConnect/api/servo_orders/close_customer_order.php" dmx-on:success="notifies1.success('Success!');list_customer_orders.load({customer_id: session_variables.data.current_customer, offset: listCustomerOrders.data.offset, limit: c_order_sort_limit.value});list_order_items.load({order_id: session_variables.data.current_order});readCustomerOrder.load({order_id: session_variables.data.current_order})">
                            <input id="update_order_order_id1" name="order_id2" type="text" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                            <input id="update_order_user_id1" name="servo_users_cashier_id3" type="text" class="form-control visually-hidden" dmx-bind:value="session_variables.data.user_id">
                            <input id="update_order_status1" name="order_status3" type="text" class="form-control visually-hidden" dmx-bind:value="'Paid'">
                            <input id="update_order_time_paid1" name="order_time_paid1" type="datetime-local" class="form-control visually-hidden" dmx-bind:value="dateTime.datetime">
                            <button id="btn25" class="btn float-right text-danger" data-bs-target="#AddProductsToOrderOffCanvas" dmx-show="(variableCustomerTotalToPay.value >='0')" style="color: #9bff66 !important;" type="submit" dmx-bind:disabled="(readCustomerOrder.data.query.order_status == 'Paid')">
                                <i class="fas fa-lock fa-2x"></i>
                            </button>
                        </form>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <div class="modal-body">
                        <div class="offcanvas offcanvas-start" id="AddProductsToOrderOffCanvas2" is="dmx-bs5-offcanvas" tabindex="-1" style="width: 99%;">
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title">{{trans.data.addProducts[lang.value]}}</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body">
                                <div class="row">
                                    <div class="col"><input id="searchProducts3" name="text3" type="text" class="form-control mb-1 form-control-lg" dmx-bind:value="searchProducts1.value" dmx-on:changed="load_products.load({service_id: list_user_shift_info.data.query_list_user_shift[0].servo_service_service_id, search: searchProducts1.value})"></div>
                                    <div class="col"><button id="btn25" class="btn btn-outline-warning ms-2 me-2 btn-lg" dmx-on:click="searchProducts1.setValue(null);load_products.load({service_id: list_user_shift_info.data.query_list_user_shift[0].servo_service_service_id})">
                                            <i class="fas fa-backspace"></i>
                                        </button></div>
                                </div>
                                <div class="row scrollable row-cols-xxl-12 mt-2" id="productDisplay2">
                                    <div class="col">
                                        <ul class="nav nav-tabs" id="navTabs1_tabs3" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="navTabs1_1_1tab2" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_1_1" role="tab" aria-controls="navTabs1_1" aria-selected="true">{{trans.data.simple[lang.value]}}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="navTabs1_2_2tab2" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_2_2" role="tab" aria-controls="navTabs1_2" aria-selected="false">{{trans.data.grouped[lang.value]}}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="navTabs1_3_tab2" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_3" role="tab" aria-controls="navTabs1_3" aria-selected="false"></a>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="navTabs1_1content2">
                                            <div class="tab-pane fade show active" id="navTabs1_1_3" role="tabpanel">
                                                <div class="row mt-md-1 ms-md-1 me-md-1 mt-sm-1 ms-sm-1 me-sm-1 mt-xxl-1 ms-xxl-1 me-xxl-1 mt-xl-1 ms-xl-1 me-xl-1 mt-lg-1 ms-lg-1 me-lg-1 mt-0 ms-1 me-1" style="margin: 2px !important;">
                                                    <div class="flex-md-wrap flex-md-row justify-content-md-center rounded align-content-center mt-2 mb-2 ms-1 me-1 pt-3 pb-3 ps-3 pe-3 offset-md-1 col-sm-5 shadow-lg border-dark bg-secondary col-xxl-3 col-xl-3 col-lg-3 col-md-5 col-12" dmx-repeat:repeatproducts="load_products.data.repeat" style="padding-top: 0px !important; margin-top: .5rem !;" id="productRepeats2">
                                                        <form id="form4" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/create_order_item.php" dmx-on:success="form3.reset();list_order_items.load({order_id: session_variables.data.current_order});notifies1.success('Success:'+product_name+' Added to Order')" dmx-on:error="notifies1.danger('Error!')">
                                                            <div class="row mt-xxl-2">
                                                                <div class="col text-center" style="padding: 0px !important; height: 200px;" dmx-hide="product_picture==null">
                                                                    <img dmx-bind:src="'/servo/uploads/product_pictures/'+product_picture" width="100%" height="95%" loading="lazy" style="object-fit: cover;">
                                                                </div>
                                                            ...
                                                            <div class="row justify-content-between mb-2 text-center">
                                                                <div class="col-4">
                                                                    <button id="btn25" class="btn btn-lg btn-secondary text-light shadow" dmx-on:click="form3.inp_order_item_quantity.setValue((inp_order_item_quantity.value.toNumber()-1) )"><i class="fas fa-minus"></i>
                                                                    </button>
                                                                </div>

                                                                <div class="col-4 text-center" style="padding: 0px !important;"><input id="inp_order_item_quantity2" name="order_item_quantity2" type="number" class="form-control mb-sm-1 mb-2 form-control-lg" placeholder="1" min="" data-rule-min="1" data-msg-min="Min. 1" style="width: 100% !important; border: 1px solid #696969 !important; border: none; background-color: transparent !important; color: #a1a1a1 !important;" dmx-bind:value="1"></div>
                                                                <div class="col-4">
                                                                    <button id="btn25" class="btn btn-lg shadow btn-secondary text-light" dmx-on:click="form3.inp_order_item_quantity.setValue((inp_order_item_quantity.value.toNumber()+1) )"><i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                            </div><input id="inp_order_time_ordered2" name="order_time_ordered2" class="form-control mb-sm-1 mb-2 visually-hidden" type="datetime-local" dmx-bind:value="var1.datetime"><input id="inp_order_item_status2" name="order_item_status2" class="form-control mb-sm-1 mb-2 visually-hidden" value="Ordered"><input id="inp_order_id2" name="servo_orders_order_id2" type="number" class="form-control mb-sm-1 mb-2 visually-hidden" dmx-bind:value="session_variables.data.current_order"><input id="inp_order_product_id2" name="servo_products_product_id2" type="number" class="form-control mb-sm-1 mb-2 visually-hidden" placeholder="1" dmx-bind:value="product_id"><input id="inp_order_item_price2" name="order_item_price2" type="number" class="form-control mb-sm-1 mb-2 visually-hidden" placeholder="1" dmx-bind:value="product_price">
                                                            <input id="inp_order_item_type2" name="order_item_type2" class="form-control mb-sm-1 mb-2 visually-hidden" placeholder="1" dmx-bind:value="'Simple'">
                                                            <input id="inp_order_item_user_ordered3" name="servo_users_user_ordered2" class="form-control mb-sm-1 mb-2 visually-hidden" placeholder="1" dmx-bind:value="session_variables.data.user_id" type="number">

                                                            <input id="orderitemDepartment2" name="servo_departments_department_id2" class="form-control mb-sm-1 mb-2 visually-hidden" placeholder="1" dmx-bind:value="sdc_department_id" type="number">
                                                            <textarea id="inp_order_notes1" class="form-control" name="order_item_notes2"></textarea>
                                                            <div class="row row-cols-xxl-7 mt-2 mt-sm-2 mt-md-2 mt-lg-2 mt-xl-2 mt-xxl-2" id="optionsrow2">
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start">
                                                                    <div id="repeatOptions2" is="dmx-repeat" dmx-bind:repeat="query_list_options">
                                                                        <button class="btn mb-xxl-2 me-xxl-2 button-repeat btn-info" dmx-text="category_option_option" dmx-bind:value="category_option_option" dmx-on:click="form3.inp_order_notes.setValue(form3.inp_order_notes.value+' '+optionsButton.value+' ')" id="optionsButton2">Button</button>
                                                                    </div>
                                                            ...
                                                            <div class="row row-cols-xxl-7 justify-content-between mt-2 mb-2" id="buttons3">
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start d-flex justify-content-start">
                                                                    ...
                                                                    <button id="btn25" class="add-item-button btn align-self-end btn-lg lh-1 text-muted" dmx-on:click="form3.inp_order_notes.setValue(null)">
                                                                        <i class="fas fa-undo fa-lg"></i>
                                                                    </button>
                                                                </div>
                                                                <div class="col w-25 flex-xxl-wrap justify-content-xxl-start d-flex justify-content-end">
                                                                    ...
                                                                    <button id="btn25" class="add-item-button btn btn-warning align-self-end btn-lg" type="submit">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="navTabs1_2_3" role="tabpanel">
                                                <div class="row mt-md-1 mt-2">
                                                    <div class="flex-xxl-wrap border border-secondary col-md-4 mb-sm-2 me-sm-2 col-lg-3 col-xl-3 col-xxl-3 mt-xxl-0 mb-xxl-3 me-xxl-3 pt-xxl-3 pb-xxl-1 ps-xxl-1 pe-xxl-1 mb-1 me-1" dmx-repeat:repeatproductgroups="load_product_groups.data.repeat_list_product_groups">
                                                        ...
                                                        <form id="addGroupedItemsToOrder2" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_groups/add_grouped_products_to_order.php" dmx-on:success="form3.reset();list_order_items.load({order_id: session_variables.data.current_order});notifies1.success('Success:'+product_name+' Added to Order')">
                                                            <input id="text14" name="servo_orders_order_id2" type="text" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                                                            <input id="text14" name="servo_users_user_ordered2" type="text" class="form-control visually-hidden" dmx-bind:value="session_variables.data.user_id">
                                                            <input id="text14" name="product_group_id2" type="text" class="form-control visually-hidden" dmx-bind:value="product_group_id">
                                                            <input id="text14" name="order_time_ordered2" type="text" class="form-control visually-hidden" dmx-bind:value="dateTime.datetime">
                        ...
                        <div class="row" id="customerOrderHeader1">
                            <dmx-value id="variableOrderTotal1" dmx-bind:value="(list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))"></dmx-value>
                            <dmx-value id="variableOrderPaid1" dmx-bind:value="list_customer_transactions_order_totals.data.custom_list_customer_transactions_order_totals[0].Settlements"></dmx-value>
                            <dmx-value id="variableOrderDiscount1" dmx-bind:value="list_order_items.data.query[0].order_discount"></dmx-value>
                            <dmx-value id="variableOrderCoverage1" dmx-bind:value="list_order_items.data.query[0].coverage_percentage"></dmx-value>
                            <dmx-value id="variableOrderCoverageTotal1" dmx-bind:value="((list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))-(((100 - readCustomerOrder.data.query.coverage_percentage) /100) * (list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))))"></dmx-value>
                            <dmx-value id="variableOrderCoveragePaid1" dmx-bind:value="list_customer_transactions_order_totals.data.custom_list_customer_transactions_order_totals[0]['Coverage Settlements']"></dmx-value>
                            <dmx-value id="variableCustomerTotal1" dmx-bind:value="{{(variableOrderTotal.value * ((100 - variableOrderDiscount.value)/100) * ((100 - variableOrderCoverage.value)/100))}}"></dmx-value>
                            <dmx-value id="variableCustomerTotalToPay1" dmx-bind:value="(variableOrderPaid.value - variableCustomerTotal.value)"></dmx-value>
                            <dmx-value id="variableCustomerOwing1" dmx-bind:value="(((list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))-((readCustomerOrder.data.query.coverage_percentage /100) * (list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))))- ((list_customer_transactions_order.data.query.sum(`transaction_amount`))))"></dmx-value>
                            <div class="col" style="">
                                <div class="row row-cols-12 justify-content-start" id="orderInfo2">
                                    <div class="justify-content-xl-end col-xl-auto col-auto" id="total1">
                                        <h6 class="ms-2 pt-2">{{trans.data.total[lang.value]}}:</h6>
                                    </div>


                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto bg-secondary rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2" id="totalAmount1">
                                        <h6 class="text-success fw-bold">{{(list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`)).formatNumber('0', ',', ',')}}</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto col-auto" id="discount2">
                                        <h6 class="ms-2 pt-2">{{trans.data.discount[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto bg-secondary rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2" id="disocuntAmount1">
                                        <h6 class="text-success fw-bold" dmx-text="((list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`))-((readCustomerOrder.data.query.order_discount / 100) * (list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`)))).formatNumber('0', ',', ',')"></h6>
                                    </div>



                                    <div class="justify-content-xl-end col-xl-auto col-auto" id="coverge1">
                                        <h6 class="ms-2 pt-2">{{trans.data.coverage[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto bg-secondary rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2" id="coverageAmount1">
                                        <h6 class="text-success fw-bold">{{readCustomerOrder.data.query.coverage_percentage}}%</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto col-auto" id="toPay4">
                                        <h6 class="ms-2 pt-2">{{trans.data.customerTotal[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-secondary" id="toPayAmount2">
                                        <h6 class="fw-bold text-white">{{(variableOrderTotal.value * ((100 - variableOrderDiscount.value)/100) * ((100 - variableOrderCoverage.value)/100)).formatNumber('0',',',',')}}</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-0 col-auto" id="paid2">
                                        <h6 class="ms-2 pt-2">{{trans.data.Paid[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-success" id="paidAmount1">
                                        <h6 class="fw-bold" dmx-text="list_customer_transactions_order_totals.data.custom_list_customer_transactions_order_totals[0].Settlements.toNumber().formatNumber('0', ',', ',').default(0)"></h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-0 col-auto" id="owing4">
                                        <h6 class="ms-2 pt-2">{{trans.data.owing[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-danger" id="owingAmount1">
                                        <h6 class="fw-bold">{{(variableCustomerTotalToPay.value).formatNumber('0',',',',')}}</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto col-auto fw-bold" id="coverageToPay2">
                                        <h6 class="ms-2 pt-2 text-warning fw-bold">{{trans.data.coverageTotal[lang.value]}}:</h6>
                                    </div>

                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 border-warning bg-transparent text-warning border" id="coverageToPayAmount2">
                                        <h6 dmx-text="variableOrderCoverageTotal.value.formatNumber('0',',',',').default(0)" class="fw-bold">{{list_customer_transactions_order.data.query.sum(`transaction_amount`)}}</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto col-auto" id="coveragePaid2">
                                        <h6 class="ms-2 pt-2 text-warning fw-bold">{{trans.data.coveragePaid[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 text-warning bg-transparent border-warning border" id="coveragePaidAmount2">
                                        <h6 dmx-text="variableOrderCoveragePaid.value.toNumber().formatNumber('0',',',',').default(0)" class="fw-bold">{{list_customer_transactions_order.data.query.sum(`transaction_amount`)}}</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto col-auto fw-bold" id="coverageOwing2">
                                        <h6 class="ms-2 pt-2 text-warning fw-bold">{{trans.data.coverageOwing[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-warning" id="coverageOwingAmount2">
                                        <h6 dmx-text="(variableOrderCoveragePaid.value  -variableOrderCoverageTotal.value).formatNumber('0',',',',').default(0)" class="fw-bold">{{list_customer_transactions_order.data.query.sum(`transaction_amount`)}}</h6>
                                    </div>
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <ul class="nav nav-tabs" id="navTabs1_tabs3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-light" id="navTabs1_13_tab3" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_13" role="tab" aria-controls="navTabs1_1" aria-selected="true">
                                            <i class="fas fa-eye fa-lg"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-light" id="navTabs1_23_tab6" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_23" role="tab" aria-controls="navTabs1_2" aria-selected="false">
                                            <i class="fas fa-cash-register fa-lg"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-light" id="navTabs1_23_tab6" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_4" role="tab" aria-controls="navTabs1_2" aria-selected="false">
                                            <i class="fas fa-coins fa-lg"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-warning" id="navTabs1_23_tab6" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_5" role="tab" aria-controls="navTabs1_2" aria-selected="false">
                                            <i class="fas fa-people-arrows fa-lg"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-light" id="navTabs1_23_tab6" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_10" role="tab" aria-controls="navTabs1_2" aria-selected="false" dmx-on:click="list_order_items_deleted.load({order_id: session_variables.data.current_order})">
                                            <i class="fas fa-trash-alt fa-sm"></i>
                                            <button id="btn25" class="btn text-danger fw-bold btn-sm mb-n1" dmx-text="list_order_items_deleted.data.list_order_items_deleted.count()"><span class="badge bg-secondary"></span>
                                            </button></a>

                                    </li>
                                </ul>
                                <div class="tab-content" id="navTabs13_content3">
                                    <div class="tab-pane fade show active" id="navTabs1_12" role="tabpanel">

                                        <div class="row">
                                            <div class="col">
                                                <div class="table-responsive" id="order_details_table2" style="">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th>{{trans.data.product[lang.value]}}</th>
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_order_items.data.query" id="tableRepeat8">
                                                            <tr>
                                                                <td dmx-text="product_name"></td>
                                                                <td dmx-text="order_time_ordered"></td>
                                                                <td dmx-text="trans.data.getValueOrKey(order_item_status)[lang.value]"></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <form id="editQuantity2" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/update_order_item_quantity.php" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order})">
                                                                        <div class="row">
                                                                            <div class="col d-flex"><input id="newQuantity2" name="order_item_quantity2" type="number" class="form-control inline-edit" dmx-bind:value="order_item_quantity" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')" min="" data-rule-min="1" data-msg-min="Min. 1">
                                                                                <input id="editOrderId2" name="order_item_id2" type="number" class="form-control inline-edit visually-hidden" dmx-bind:value="order_item_id"><button id="btn25" class="btn text-success" data-bs-target="#productInfo" type="submit" dmx-hide="(read_item_order.data.query.order_status == 'Paid')"><i class="fas fa-check"><br></i></button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </td>
                                                                <td>
                                                                    <form id="editPrice2" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/update_order_item_price.php" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order})">
                                                                        <div class="row">
                                                                            <div class="col d-flex"><input id="newPrice2" name="order_item_price2" type="number" class="form-control inline-edit" dmx-bind:value="order_item_price" dmx-bind:disabled="(readCustomerOrder.data.query.order_status == 'Paid')&amp;&amp;(profile_privileges.data.profile_privileges[0].edit_order_item_price == 'No')" min="" data-rule-min="0" data-msg-min="Min. 0">
                                                                                <input id="editOrderItemPrice2" name="order_item_id2" type="number" class="form-control inline-edit visually-hidden" dmx-bind:value="order_item_id">
                                                                                <button id="btn25" class="btn text-success" data-bs-target="#productInfo" type="submit" dmx-hide="(read_item_order.data.query.order_status == 'Paid')&amp;&amp;(profile_privileges.data.profile_privileges[0].edit_order_item_price == 'No')"><i class="fas fa-check"><br></i>
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                ...
                                                                <td>
                                                                    <div class="row" is="dmx-if" id="conditional9" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].delete_order_item == 'Yes')">
                                                                        <form id="form4" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/delete_order_item.php" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order})" dmx-class:hidethis="" onsubmit=" return confirm('CONFIRM DELETE?');">
                                                                            <input id="text14" name="order_item_id2" type="text" class="form-control visually-hidden" dmx-bind:value="order_item_id">
                                                                            <input id="text14" name="order_id2" type="text" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                                                                            <input id="text14" name="user_deleted1" type="text" class="form-control visually-hidden" dmx-bind:value="list_user_shift_info.data.query_list_user_shift[0].servo_user_user_id">
                                                                            <input id="text14" name="deleted_product_id1" type="text" class="form-control visually-hidden" dmx-bind:value="servo_products_product_id">
                                                                            <button id="btn25" class="btn text-secondary" data-bs-target="#productInfo" type="submit"><i class="far fa-trash-alt fa-lg"><br></i></button>
                                                                        </form>
                                                                    </div>
                                        ...
                                        <div class="row" id="orderUpdate2">
                                            <form is="dmx-serverconnect-form" id="updateOrderCashierStandard2" method="post" action="dmxConnect/api/servo_orders/update_order_discount_note.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');list_order_items.load({order_id: session_variables.data.current_order});readCustomerOrder.load({order_id: session_variables.data.current_order})">


                                                <div class="mb-3 row">
                                                    <label for="inp_order_notes1" class="col-sm-2 col-form-label">{{trans.data.note[lang.value]}}</label>

                                                    <div class="col-sm-10">
                                                        <textarea type="textarea" class="form-control" id="inp_order_notes1" name="order_notes1" dmx-bind:value="readCustomerOrder.data.query.order_notes" aria-describedby="inp_order_notes_help"></textarea>
                                                    </div>
                                                </div><input id="order_id4" name="order_id2" class="form-control visually-hidden" dmx-bind:value="readCustomerOrder.data.query.order_id">

                                                <div class="row">
                                                    <label for="inp_order_notes1" class="col-sm-2 col-form-label">{{trans.data.discount[lang.value]}}</label>
                                                    <div class="col"><input id="orderDiscount1" name="order_discount1" class="form-control" dmx-bind:value="readCustomerOrder.data.query.order_discount" required="" type="number" data-msg-required="!" min="" data-rule-min="0" data-msg-min="Min 0!" dmx-bind:max="100">
                                                ...
                                                <div class="row mt-2 mb-3">
                                                    ...
                                                    <label for="inp_order_notes1" class="col-sm-2 col-form-label"></label>
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-warning me-md-1 pt-md-2 pb-md-2 ps-md-2 pe-md-2 me-2" dmx-bind:value="read_item_order.data.query.Save" type="submit" dmx-hide="(read_item_order.data.query.order_status == 'Paid')">
                                                            <i class="fas fa-check fa-2x"></i>
                                                        </button>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_12" role="tabpanel">
                                        <div class="row mt-2 visually-hidden">
                                            <form is="dmx-serverconnect-form" id="updateOrderCashier3" method="post" action="dmxConnect/api/servo_orders/update_order_ordered_paid.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');list_orders_all_shift_department.load({current_shift: session_variables.data.current_shift, department_id: list_user_shift_info.data.query_list_user_shift[0].user_shift_department_id});updateOrderCashier.reset();readItemModal.hide()">
                                                <input id="order_id4" name="order_id2" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                                                <div class="mb-3 row">
                                                    <label for="inp_order_amount_tendered3" class="col-sm-2 col-form-label">{{trans.data.amountTendered[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="inp_order_amount_tendered3" name="order_amount_tendered3" dmx-bind:value="readCustomerOrder.data.query.order_amount_tendered" aria-describedby="inp_order_notes_help" required="" data-msg-required="!" min="" data-msg-min="Min 0" dmx-bind:min="list_order_items.data.query.sum(`(order_item_price * order_item_quantity)`)" dmx-bind:disabled="(readCustomerOrder.data.query.order_status == 'Paid')" data-rule-min="1">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="inp_order_balance3" class="col-sm-2 col-form-label">{{trans.data.balance[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="inp_order_balance3" name="order_balance3" aria-describedby="inp_order_notes_help" dmx-bind:value="(updateOrderCashier.inp_order_amount_tendered.value - orderTotal.value)" disabled="true" dmx-bind:disabled="(readCustomerOrder.data.query.order_status == 'Paid')">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-10 visually-hidden">
                                                        <input type="number" class="form-control" id="inp_order_cashier_id3" name="servo_users_cashier_id3" aria-describedby="inp_order_notes_help" dmx-bind:value="session_variables.data.user_id">
                                                    </div>
                                                    <div class="col-sm-10 visually-hidden">
                                                        <input class="form-control" id="inp_order_order_status3" name="order_status3" dmx-bind:value="'Ordered'" aria-describedby="inp_order_notes_help">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="customersearch" class="col-sm-2 col-form-label">{{trans.data.paymentMethod[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select id="select8" class="form-select" dmx-bind:options="payment_methods.data.query" optiontext="payment_method_name" optionvalue="payment_method_id" dmx-bind:value="readCustomerOrder.data.query.servo_payment_methods_payment_method" name="servo_payment_methods_payment_method3" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-2">
                                                        &nbsp;</div>
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-success pt-md-2 pb-md-2 ps-md-2 pe-md-2" id="receive_payment4" dmx-on:click="updateOrderCashier.inp_order_order_status.setValue('Paid');updateOrderCashier.submit()" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')"><i class="fas fa-hand-holding-usd fa-2x"></i></button>
                                                    </div>
                                        ...
                                        <div class="row mt-2">
                                            <form is="dmx-serverconnect-form" id="createOrderTransaction1" method="post" action="dmxConnect/api/servo_customer_cash_transactions/create_transaction.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="createOrderTransaction.reset();list_customer_transactions.load({customer_id: session_variables.data.current_customer});list_customer_transactions_order.load({order_id: session_variables.data.current_order});notifies1.success('Success');updateOrderCashier.reset();readItemModal.hide();list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_orders_totals.load({customer_id: session_variables.data.current_customer});list_customer_transactions_order_totals.load({order_id: session_variables.data.current_order})" dmx-on:error="notifies1.danger('Error!')">
                                                <input id="transactionOrderId2" name="transaction_order1" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                                                <input id="transactionCustomer2" name="customer_id1" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_customer">
                                                <input id="transactionDate3" name="transaction_date1" class="form-control visually-hidden" dmx-bind:value="dateTime.datetime">
                                                <input id="transactionUserApproved2" name="user_approved_id1" class="form-control visually-hidden" dmx-bind:value="session_variables.data.user_id">
                                                <input id="transactionType3" name="transaction_type1" class="form-control visually-hidden" dmx-bind:value="'Settlement'">
                                                <div class="mb-3 row">
                                                    <label for="transactionAmount1" class="col-sm-2 col-form-label">{{trans.data.total[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="transactionAmount3" name="transaction_amount1" aria-describedby="inp_order_notes_help" required="" data-msg-required="!" min="" data-msg-min="Min 0" dmx-bind:min="1" data-rule-min="1" dmx-bind:value="-variableCustomerTotalToPay.value.round(0)" dmx-bind:max="-(variableCustomerTotalToPay.value)" max="" data-msg-max=">Max!">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="transactionAmountTendered2" class="col-sm-2 col-form-label">{{trans.data.amountTendered[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="transactionAmountTendered2" name="transaction_amount_tendered1" aria-describedby="inp_order_notes_help" required="" data-msg-required="!" min="" data-msg-min="Min 0" dmx-bind:min="createOrderTransaction.transactionAmount.value" data-rule-min="1">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="transactinBalance1" class="col-sm-2 col-form-label">{{trans.data.balance[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="transactinBalance1" name="transaction_balance1" aria-describedby="inp_order_notes_help" dmx-bind:value="(createOrderTransaction.transactionAmountTendered.value - createOrderTransaction.transactionAmount.value)" readonly="true">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="customersearch" class="col-sm-2 col-form-label">{{trans.data.paymentMethod[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select id="select8" class="form-select" dmx-bind:options="payment_methods.data.query" optiontext="payment_method_name" optionvalue="payment_method_id" name="transaction_payment_method1" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')">
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-2">
                                                        &nbsp;</div>
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-success pt-md-2 pb-md-2 ps-md-2 pe-md-2" id="receive_payment4" dmx-on:click="updateOrderCashier.inp_order_order_status.setValue('Paid');updateOrderCashier.submit()" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')" type="submit"><i class="fas fa-hand-holding-usd fa-2x"></i></button>
                                                    </div>
                                            ...
                                            <div class="col">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-sm">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_customer_transactions_order.data.query" id="tableRepeat8">
                                                            <tr>
                                                                <td dmx-text="customer_transaction_id"></td>
                                                                ...
                                                                <td dmx-text="transaction_balance.formatNumber('0', ',', ',')"></td>
                                                                <td>
                                                                    <button id="btn25" class="btn" data-bs-toggle="modal" data-bs-target="#printTransactionReceiptModal" dmx-on:click="read_customer_transaction.load({customer_cash_transaction_id: customer_transaction_id})"><i class="fas fa-receipt fa-lg"></i>
                                                                    </button>
                                                                </td>
                                                                <td>
                                                                    <form id="deleteOrderTransaction1" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_customer_cash_transactions/delete_transaction.php" dmx-on:success="list_customer_transactions_order.load({order_id: readCustomerOrder.data.query.order_id});list_customer_transactions.load({customer_id: session_variables.data.current_customer});list_customer_transactions_order_totals.load({order_id: session_variables.data.current_order})" onsubmit=" return confirm('CONFIRM DELETE?');">
                                                                        <input id="text14" name="customer_transaction_id1" type="text" class="form-control visually-hidden" dmx-bind:value="customer_transaction_id">
                                                                        <button id="btn25" class="btn text-secondary" type="submit">
                                                                            <i class="far fa-trash-alt fa-lg"></i>
                                                                        </button>
                                                                    </form>
                                                                </td>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_12" role="tabpanel">
                                        ...
                                        <div class="row mt-2">
                                            <form is="dmx-serverconnect-form" id="coveragePartner1" method="post" action="dmxConnect/api/servo_orders/update_order_coverage_partner.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');readCustomerOrder.load({order_id: session_variables.data.current_order});list_order_items.load({order_id: session_variables.data.current_order})" dmx-on:error="notifies1.danger('Error!')">
                                                <input id="orderIdCoverage1" name="order_id2" class="form-control visually-hidden" dmx-bind:value="session_variables.data.current_order">
                                                <input id="orderCoverageStatus1" name="coverage_payment_status1" class="form-control visually-hidden" dmx-bind:value="'Ordered'">
                                                <div class="mb-3 row">
                                                    <label for="transactionAmount1" class="col-sm-2 col-form-label">{{trans.data.coverage[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" id="coveragePercentage1" name="coverage_percentage1" aria-describedby="inp_order_notes_help" required="" data-msg-required="!" dmx-bind:value="readCustomerOrder.data.query.coverage_percentage" min="" data-rule-min="0" data-msg-min="MIn 0!" dmx-bind:max="100">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="coveragePartner1" class="col-sm-2 col-form-label">{{trans.data.Partner[lang.value]}}</label>
                                                    <div class="col-sm-10">
                                                        <select id="select8" class="form-select" dmx-bind:options="list_customers_special.data.query_list_customers" optiontext="customer_first_name+' '+customer_last_name+' '+customer_phone_number" optionvalue="customer_id" name="coverage_partner1" dmx-bind:value="readCustomerOrder.data.query.coverage_partner">
                                                            <option value="%">{{trans.data.partner[lang.value]}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-success pt-md-2 pb-md-2 ps-md-2 pe-md-2" id="receive_payment4" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')" type="submit"><i class="fas fa-check"></i></button>
                                                    </div>
                                            ...
                                            <div class="col">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-sm">
                                                        ...
                                                        <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_order_items_deleted.data.list_order_items_deleted" id="tableRepeat8">
                                                            <tr>
                                                                <td dmx-text="product_name"></td>
                                                                <td dmx-text="time_deleted"></td>
                                                                <td dmx-text="user_username"></td>
                                                                <td>
                                                                    <div class="row" id="deleteDeletedItem1" is="dmx-if" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].delete_order == 'Yes')">
                                                                        <form id="deleteItemDelete1" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_order_items/delete_order_item_deleted.php" dmx-on:success="notifies1.success('Success!');list_order_items_deleted.load({order_id: session_variables.data.current_order})" dmx-on:error="notifies1.warning('Error')">
                                                                            <input id="deleteOrderItemId1" name="order_item_delete_id1" type="text" class="form-control visually-hidden" dmx-bind:value="order_item_delete_id">
                                                                            <button id="btn25" class="btn text-secondary" type="submit">
                                                                                <i class="far fa-trash-alt fa-lg"></i>
                                                                            </button>
                                                                        </form>
                        ...
                        <div class="row text-end" is="dmx-if" id="conditional9" dmx-bind:condition="(profile_privileges.data.profile_privileges[0].delete_order == 'Yes')">
                            <form id="form4" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_orders/delete_order_and_items.php" dmx-on:success="notifies1.success('Success');list_orders_all_shift.load();customerOrderModal.hide();list_customer_orders_totals.load({customer_id: session_variables.data.current_customer});list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer})" onsubmit=" return confirm('CONFIRM DELETE?');">
                                <input id="text14" name="order_id2" type="number" class="form-control visually-hidden" dmx-bind:value="readCustomerOrder.data.query.order_id">
                    ...
                    <div class="modal-header">
                        ...
                        <div class="d-block">
                            <main>
                                <div class="row justify-content-start justify-content-xxl-start justify-content-lg-start justify-content-md-start justify-content-sm-start justify-content-xl-start row-cols-xl-7 rounded-pill">
                                    <div class="d-flex col-xl-auto rounded rounded-3 col-auto">
                                        <h4 class="text-light">{{trans.data.coverageOrder[lang.value]}}</h4>
                                    </div>
                                    <div class="d-flex col-xl-auto rounded rounded-3 col-auto">
                                        <h4 class="text-light" dmx-text="readCustomerOrder.data.query.order_id"></h4>
                                    </div>
                        ...
                        <div class="row" id="customerOrderHeader2">
                            ...
                            <div class="col" style="">
                                ...
                                <div class="row row-cols-12 justify-content-start" id="orderInfo1">
                                    ...
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-success" id="paidAmount3">
                                        <h6 class="fw-bold" dmx-text="list_customer_transactions_order_totals.data.custom_list_customer_transactions_order_totals[0].Settlements.toNumber().formatNumber('0', ',', ',').default(0)"></h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-0 col-auto" id="owing2">
                                        <h6 class="ms-2 pt-2">{{trans.data.owing[lang.value]}}:</h6>
                                    </div>
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-danger" id="owingAmount2">
                                        <h6 class="fw-bold">{{(variableCustomerTotalToPay.value).formatNumber('0',',',',')}}</h6>
                                    </div>
                                    ...
                                    <div class="justify-content-xl-end col-xl-auto offset-xl-0 col-auto rounded-pill rounded-2 align-self-center align-self-xxl-center align-self-xl-center align-self-lg-center align-self-md-center pt-2 bg-warning" id="coverageOwingAmount1">
                                        <h6 dmx-text="(variableOrderCoveragePaid.value  -variableOrderCoverageTotal.value).formatNumber('0',',',',').default(0)" class="fw-bold">{{list_customer_transactions_order.data.query.sum(`transaction_amount`)}}</h6>
                                    </div>
                                            ...
                                            <form is="dmx-serverconnect-form" id="createOrderCoverageTransaction" method="post" action="dmxConnect/api/servo_customer_cash_transactions/create_transaction.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="createOrderCoverageTransaction.reset();list_customer_transactions.load({customer_id: session_variables.data.current_customer});list_customer_transactions_order.load({order_id: session_variables.data.current_order});notifies1.success('Success');updateOrderCashier.reset();readItemModal.hide();list_customer_transactions_amounts.load({customer_id: session_variables.data.current_customer});list_customer_transactions_order_totals.load({order_id: session_variables.data.current_order})" dmx-on:error="notifies1.danger('Error!')">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select id="select72" class="form-select" dmx-bind:options="payment_methods.data.query" optiontext="payment_method_name" optionvalue="payment_method_id" name="transaction_payment_method" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')">
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-2">
                                                        &nbsp;</div>
                                                    <div class="col-sm-10 d-flex justify-content-start">
                                                        <button class="btn btn-success pt-md-2 pb-md-2 ps-md-2 pe-md-2" id="receive_payment31" dmx-on:click="updateOrderCashier.inp_order_order_status.setValue('Paid');updateOrderCashier.submit()" dmx-bind:disabled="(read_item_order.data.query.order_status == 'Paid')" type="submit"><i class="fas fa-hand-holding-usd fa-2x"></i></button>
                                                    </div>
                            ...
                            <div class="col">
                                ...
                                <div class="tab-content" id="navTabs13_content1">
                                    <div class="tab-pane fade show active" id="navTabs1_7" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <h1 wappler-command="editContent" id="readingHeading" dmx-text="currentReading.value" class="text-center mt-2 mb-2"></h1>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="navTabs1_77" role="tabpanel">
                                        ...
                                        <div class="row mt-2 visually-hidden" wappler-empty="Row" wappler-command="addElementInside">
                                        </div>
                                    </div>
