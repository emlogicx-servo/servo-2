                ...
                <div class="col-md mt-1 pt-3 col" style="height: 75vh !important;">
                    ...
                    <div class="tab-content" id="navTabs1_content">
                        <div class="tab-pane fade show active  " id="navTabs1_2_1" role="tabpanel" aria-labelledby="navTabs1_2_tab_1">
                            <div class="row ms-0 me-2 scrollable">
                                <div class="col">
                                    <div class="row row-cols-12 align-items-center mt-2 ms-0">
                                        <div class="d-flex col-auto rounded bg-light align-items-center h-auto mt-2 me-2 pt-4 pb-4 ps-4 pe-4">
                                        ...
                                        <div class="col-xxl-auto col-auto text-body rounded bg-light mt-2 me-2 pt-2 ps-2 pe-2">
                                            <div class="d-flex">
                                                <h4 dmx-text="trans.data.sales[lang.value]+': '+SalesReportShift.data.product_report.sum(`Total`).formatNumber('0',',',',')" class="me-3"></h4>
                                                <h4 dmx-text="trans.data.volume[lang.value]+': '+SalesReportShift.data.product_report.sum(`Volume`).formatNumber('0',',',',')">{{trans.data.volume[lang.value]}}:</h4>
                                            </div>
                                        </div>
                                        <div class="d-flex col-auto rounded align-items-center bg-light mt-2 pt-2">
                                            <h4 class="text-success"><i class="fas fa-arrow-alt-circle-down" style="/* color: #89F387 !important */"></i></h4>
                        ...
                        <div class="tab-pane fade" id="navTabs1_1_2" role="tabpanel" aria-labelledby="navTabs1_1_tab_2">
                            <div class="row mt-2">
                                <div class="rounded rounded-3 bg-secondary col" style="max-height: 65vh; overflow-y: scroll;">
                                    <div class="table-responsive">
