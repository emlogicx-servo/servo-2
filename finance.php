...
<body is="dmx-app" id="brands" dmx-on:ready="preloader1.hide()">
  ...
  <dmx-serverconnect id="list_wallet_transactions" url="dmxConnect/api/servo_wallet_transactions/list_wallet_transactions.php" dmx-param:sort="" dmx-param:dir="" dmx-param:limit="" dmx-param:offset="" dmx-param:customerfilter="customerfilter.value" dmx-param:customerfilter2="customerfilter2.value" dmx-param:wallet_id="read_wallet.data.read_wallet.wallet_id" dmx-on:start="readItemModal.preloader2.show()" dmx-on:done="readItemModal.preloader2.hide()"></dmx-serverconnect>
