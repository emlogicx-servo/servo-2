      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="text-white">{{read_item_product_group.data.read_product_group.product_group_name}}</h3>
                      ...
                      <form id="createproductGroupItem" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_group_items/create_product_group_item.php" dmx-on:success="notifies1.success('Success');createproductGroupItem.reset();list_product_group_items.load({product_group_id: read_item_product_group.data.read_product_group.product_group_id})" dmx-on:error="notifies1.danger('Error!')" class="d-flex">
                        <div class="row row-cols-xl-9 justify-content-xl-start justify-content-start pt-3 row-cols-6">
                          <div class="d-flex flex-wrap col-9 col-sm-9 col-xxl-12 col-lg-12 col-xl-12">
                            ...
                            <input id="groupProductSearch" name="product_group_product" type="text" class="form-control mb-1 me-1" dmx-on:updated="list_item_products_for_group.load({productfilter: createproductGroupItem.groupProductSearch.value, offset: list_products_for_group.data.offset_group_product, limit: 5})" style="width: 120px !important;"><button id="btn15" class="btn btn-outline-secondary mb-1 me-1" dmx-on:click="createproductGroupItem.groupProductSearch.setValue((''))">
                            ...
                            </select><button id="btn9" class="btn btn-warning mb-1" type="submit">
                              ...
                              <tr>
                                ...
                                <td>
                                  <form id="deleteProductGroupItem" method="post" is="dmx-serverconnect-form" class="d-flex" action="dmxConnect/api/servo_product_group_items/delete_product_group_item.php" dmx-on:success="list_product_group_items.load();notifies1.success('Success!')">
                                    ...
                                    <button id="btn12" class="btn text-danger" type="submit"><i class="far fa-trash-alt"></i>
                                    </button>
                                  </form>
    ...
    <div class="modal readitem" id="readItemModal" is="dmx-bs5-modal" tabindex="-1" style="" nocloseonclick="true">
      <div class="modal-dialog modal-xl modal-fullscreen-xxl-down modal-dialog-scrollable" role="document" style="margin: 0px !important; width: 100% !important; height: 99% !important; max-width: 100% !important; max-height: 99% !important;">
        <div class="modal-content" style="max-height: 100% !important; height: 100% !important;">
          <div class="modal-header">
            <h3 class="text-light">{{read_item_product.data.query_read_product.product_name}}</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col">
                <ul class="nav nav-tabs" id="navTabs2_tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="navTabs2_1_tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs2_1" role="tab" aria-controls="navTabs1_1" aria-selected="true">{{trans.data.info[lang.value]}}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="navTabs2_2_tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs2_2" role="tab" aria-controls="navTabs1_2" aria-selected="false">{{trans.data.prices[lang.value]}}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-warning" id="navTabs2_3_tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs2_3" role="tab" aria-controls="navTabs1_3" aria-selected="false"><i class="fas fa-chart-line fa-lg"></i></a>
                  </li>
                </ul>
                <div class="tab-content" id="navTabs2_content">
                  <div class="tab-pane fade show active mt-2" id="navTabs2_1" role="tabpanel">
                    <div class="row">
                      <div class="col-xl-4 col-lg-6 col-12 text-sm-center text-center col-md-6 text-md-center rounded rounded-1 border-light pt-2 pb-2"><img dmx-bind:src="'/servo/uploads/product_pictures/'+read_item_product.data.query_read_product.product_picture" class="img-fluid rounded-0" width="300" dmx-hide="(read_item_product.data.query_read_product.product_picture == null)" loading="lazy">
                          ...
                          <div class="col text-xxl-center text-center">
                            <div class="row mt-2">
                              <form id="replaceProductPicture" class="d-flex" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_products/replace_product_picture.php" dmx-on:success="notifies1.success('Success!');read_item_product.load({product_id: read_item_product.data.query_read_product.product_id})"><input id="text4" name="product_picture" type="text" class="form-control visually-hidden">
                                ...
                                <button id="btn7" class="btn btn-success ms-xxl-2 ms-xl-2 ms-lg-2 ms-md-2 ms-sm-2 ms-2" type="submit" dmx-show="replaceProductPicture.product_picture_file.value+'!='+null">
                  ...
                  <div class="tab-pane fade mt-2" id="navTabs2_2" role="tabpanel">
                    <h5>{{trans.data.setPrice[lang.value]}}</h5>
                    <div class="row mt-3 justify-content-center">
                      <form id="createServicePrice" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_prices/create_product_price.php" dmx-on:success="createServicePrice.reset();load_product_prices.load({});notifies1.success('Success')" dmx-on:error="notifies1.danger('Error!')" class="d-flex">
                        <div class="row justify-content-end">
                          ...
                          <div class="col">
                            <button id="btn4" class="btn btn-warning" type="submit">
                              <i class="fas fa-plus-circle"></i>
                            </button>
                          </div>
                        </div>
                                ...
                                <td class="text-center">
                                  <form id="deletePrice" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_prices/delete_product_price.php" dmx-on:success="productPriceSet.reset();notifies1.success('Success!');load_product_prices.load({});load_departments.load({})">
                                    <div class="row">
                                      ...
                                      <div class="col">
                                        <button id="btn8" class="btn text-danger" type="submit">
                  ...
                  <div class="tab-pane fade mt-2" id="navTabs2_3" role="tabpanel">
                      ...
                      <div class="col-xxl col-xxl-3 col-12 col-sm-8 col-lg-2 mb-2">
                        ...
                        <div class="row mt-2">
                          <div class="bg-secondary ms-2 pt-2 col-12 border-start border-3 border-light">
                            <h4 class="text-center text-light fw-bold">{{(salesTotal.value / salesVolume.value).formatNumber('0', ',', ',')}}</h4>
                            <h5 class="text-center text-light">{{trans.data.averageSalesPrice[lang.value]}}</h5>
                          </div>
                        </div>
                    ...
                    <div class="row mt-2 justify-content-md-center bg-secondary justify-content-xl-center justify-content-xxl-center">
                      <div class="border-3 border-success justify-content-xxl-center mb-xxl-2 me-xxl-1 mb-1 ms-2 pt-2 mb-sm-1 col-xxl-6 col-5 col-lg-3">
                        ...
                        <h5 class="text-center text-white-50">{{trans.data.unitMargin[lang.value]}}</h5>
                      </div>
                      <div class="border-3 mb-1 ms-2 pt-2 mb-xxl-1 me-xxl-1 col-xxl-6 col-5 border-success col-lg-3">
                        ...
                        <h5 class="text-center text-white-50">{{trans.data.profit[lang.value]}}</h5>
                      </div>
                    </div>
                      ...
                      <div class="col-xxl col-12 col-sm-8 mb-2 col-xxl-2 col-lg-2">
                        ...
                        <div class="row mt-2">
                          <div class="ms-2 pt-2 col-12 border-start border-3 border-light">
                            <h4 class="text-center text-light fw-bold">{{(purchasesTotal.value / purchasesVolume.value).formatNumber('0',',',',')round(2).default(0)}}</h4>
                            <h5 class="text-center text-light">{{trans.data.averagePurchasePrice[lang.value]}}</h5>
                          </div>
                        </div>
                      </div>
                      <div class="ps-2 pe-2 col-lg-4">
                      ...
                      <div class="col-xxl col-xxl-3 col-12 col-sm-8 col-lg-2 mb-2">
                        ...
                        <div class="row mt-2">
                          <div class="bg-secondary ms-2 pt-2 col-12 border-start border-3 border-danger">
                            ...
                            <h4 class="text-center text-white">{{trans.data.total[lang.value]}}</h4>
                          </div>
                        </div>
                      </div>
                      <div class="ps-2 pe-2 col-lg-4">
    ...
    <div class="container mt-auto">
      ...
      <div class="row servo-page-header">
        <div class="col-auto " dmx-animate-enter="slideInLeft">
          <i class="fas fa-barcode fa-2x" style="color: #fffa18 !important;"></i>
        </div>
        <div class="col-auto page-heading">
          <h3 class="servo-page-heading fw-lighter">{{trans.data.products[lang.value]}}</h3>
        </div>

        <div class="col style13 page-button" id="pagebuttons">
          <button id="btn1" class="btn style12 fw-light text-light  btn-dark" data-bs-toggle="modal" data-bs-target="#createItemModal" style="float: right;"><i class="fas fa-plus style14 fa-lg"></i></button>
        </div>
      </div>
      <ul class="nav nav-tabs" id="navTabs1_tabs" role="tablist">
        <li class="nav-item">
      ...
      <div class="tab-content" id="navTabs1_content">
        ...
        <div class="tab-pane fade show active mt-3 scrollable" id="navTabs1_11" role="tabpanel">
          ...
          <div class="row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between sorter shadow-none">
            <div class="col-lg-3 col-12 col-sm-12"><input id="productSearch" name="text13" type="text" class="form-control mb-2 form-control-sm" dmx-bind:placeholder="trans.data.search[lang.value]+'  '" style="background: #242424 !important;"></div>
                ...
                <table class="table table-hover table-sm table-borderless">
                  ...
                  <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_item_products.data.query_list_products.data" id="tableRepeat2">
                    <tr>
                      ...
                      <td class="text-end"><button id="btn2" class="btn  open" data-bs-target="#readItemModal" dmx-on:click="readItemModal.show();read_item_product.load({product_id: product_id});product_sales_single.load({product_id: product_id})" dmx-bind:value="product_id" wappler-empty="Editable" wappler-command="editContent"><i class="fas fa-expand-alt fa-lg"><br></i></button></td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div class="tab-pane fade mt-3 scrollable" id="navTabs1_21" role="tabpanel">
          <div class="row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between mb-xl-2 mb-2 sorter">
            <div class="col-xxl-3 col-12 col-sm-12 col-lg-3"><input id="groupFilter" name="text13" type="text" class="form-control mb-2 form-control-sm" dmx-bind:placeholder="trans.data.search[lang.value]+'  '" style="background: #242424 !important;"></div>
                ...
                <table class="table table-hover table-sm table-borderless">
                  ...
                  <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_product_groups.data.list_product_groups.data" id="tableRepeat4">
                    <tr>
                      ...
                      <td>
                        <button class="btn open" data-bs-target="#readProductGroupModal" dmx-on:click="readProductGroupModal.show();read_item_product_group.load({product_group_id: product_group_id})" dmx-bind:value="list_product_groups.data.list_product_groups[0].product_group_id" data-bs-toggle="modal"><i class="fas fa-expand-alt fa-lg"><br></i></button>
                      </td>
                      <td>

                        <form id="deleteProductGroup" method="post" is="dmx-serverconnect-form" action="dmxConnect/api/servo_product_groups/delete_product_group.php" dmx-on:success="notifies1.success('Success');list_product_groups.load({groupfilter: groupFilter.value, offset: list_groups.data.offset, limit: group_sort_limit.value})" dmx-on:error="notifies1.warning('Error')"><input id="productGroupId" name="product_group_id" type="text" class="form-control visually-hidden" dmx-bind:value="product_group_id"><button class="btn text-secondary" data-bs-target="#productInfo" type="submit"><i class="far fa-trash-alt fa-lg"><br></i></button></form>
