...
<body is="dmx-app" id="header">
    <dmx-query-manager id="listShiftsPaged"></dmx-query-manager>
    ...
    <dmx-serverconnect id="list_shifts" url="dmxConnect/api/servo_shifts/list_shifts.php" dmx-param:shift_id="session_variables.data.current_shift" dmx-param:user_id="session_variables.data.user_id" dmx-param:limit="10" dmx-param:offset="listShiftsPaged.data.listShiftsOffset"></dmx-serverconnect>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body bg-light">
                    <div class="row">
                        <div class="col">
                            <ul class="pagination" dmx-populate="list_shifts.data.query_list_shifts" dmx-state="listShiftsPaged" dmx-offset="listShiftsOffset" dmx-generator="bs5paging">
                                <li class="page-item" dmx-class:disabled="list_shifts.data.query_list_shifts.page.current == 1" aria-label="First">
                                    <a href="javascript:void(0)" class="page-link" dmx-on:click="listShiftsPaged.set('listShiftsOffset',list_shifts.data.query_list_shifts.page.offset.first)"><span aria-hidden="true">&lsaquo;&lsaquo;</span></a>
                                </li>
                                <li class="page-item" dmx-class:disabled="list_shifts.data.query_list_shifts.page.current == 1" aria-label="Previous">
                                    <a href="javascript:void(0)" class="page-link" dmx-on:click="listShiftsPaged.set('listShiftsOffset',list_shifts.data.query_list_shifts.page.offset.prev)"><span aria-hidden="true">&lsaquo;</span></a>
                                </li>
                                <li class="page-item" dmx-class:active="title == list_shifts.data.query_list_shifts.page.current" dmx-class:disabled="!active" dmx-repeat="list_shifts.data.query_list_shifts.getServerConnectPagination(2,1,'...')">
                                    <a href="javascript:void(0)" class="page-link" dmx-on:click="listShiftsPaged.set('listShiftsOffset',(page-1)*list_shifts.data.query_list_shifts.limit)">{{title}}</a>
                                </li>
                                <li class="page-item" dmx-class:disabled="list_shifts.data.query_list_shifts.page.current ==  list_shifts.data.query_list_shifts.page.total" aria-label="Next">
                                    <a href="javascript:void(0)" class="page-link" dmx-on:click="listShiftsPaged.set('listShiftsOffset',list_shifts.data.query_list_shifts.page.offset.next)"><span aria-hidden="true">&rsaquo;</span></a>
                                </li>
                                <li class="page-item" dmx-class:disabled="list_shifts.data.query_list_shifts.page.current ==  list_shifts.data.query_list_shifts.page.total" aria-label="Last">
                                    <a href="javascript:void(0)" class="page-link" dmx-on:click="listShiftsPaged.set('listShiftsOffset',list_shifts.data.query_list_shifts.page.offset.last)"><span aria-hidden="true">&rsaquo;&rsaquo;</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_shifts.data.query_list_shifts.data" id="tableRepeat1">
                                <tr>
