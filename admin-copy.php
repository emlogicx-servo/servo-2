...
<body is="dmx-app" id="ServoCashier">
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-secondary">
                        ...
                        <div class="d-block">
                            <h4 class="text-light">{{trans.data.orderDetails[lang.value]}}</h4>
                        </div><button id="btn13" class="btn float-right text-warning ms-4 visually-hidden" data-bs-toggle="modal" data-bs-target="#printReceipt" dmx-on:click="" dmx-animate-enter.duration:20000.delay:100="pulse" dmx-class:show-print-2="(read_item_order.data.query.order_status == 'Paid')">
                    ...
                    <div class="modal-body bg-secondary">
                        ...
                        <div class="row">
                            <div class="d-flex col justify-content-start flex-wrap">
                                ...
                                <div class="d-block">
                                    <h4 class="text-light">{{trans.data.waiter[lang.value]}}:</h4>
                                </div>
                                <div class="d-block ms-2">
                                    <h4 class="text-info" dmx-text="read_item_order.data.query.user_username.titlecase()"></h4>
                                </div>
                                <div class="d-block ms-2">
                                    <h4 class="ms-1 text-light">{{trans.data.table[lang.value]}}:</h4>
                                </div>
                                <div class="d-block ms-2">
                                    <h4 class="text-success" dmx-text="list_order_items.data.query[0].table_name">&nbsp;</h4>
                                </div>
                                <div class="d-block ms-2">
                                    <h4 class="ms-2">{{trans.data.total[lang.value]}}:</h4>
                                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <ul class="nav nav-tabs" id="navTabs1_tabs1" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-light" id="navTabs1_1_tab" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_1" role="tab" aria-controls="navTabs1_1" aria-selected="true">
                                        ...
                                        <form is="dmx-serverconnect-form" id="updateOrderCashierStandard" method="post" action="dmxConnect/api/servo_orders/update_order_standard.php" dmx-generator="bootstrap5" dmx-form-type="horizontal" dmx-populate="read_item_order.data.query" dmx-on:success="notifies1.success('Success');list_orders_all_shift.load({current_shift: 'session_variables.current_shift'});readItemModal.update();list_orders_credit.load();readItemModal.hide()">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 d-flex justify-content-start">
                                                    <button class="btn btn-warning me-2 ms-md-2 me-md-1 pt-md-2 pb-md-2 ps-md-2 pe-md-2" dmx-bind:value="read_item_order.data.query.Save" type="submit" dmx-hide="(profile_privileges.data.profile_privileges[0].edit_order_details == 'No')">
    ...
    <main class="bg-secondary">
        <div class="ms-4 me-4">
            ...
            <div class="row justify-content-between h-auto w-auto numbers mt-3 pt-3 pb-2 ps-1 pe-1 bg-body rounded">
            ...
            <div class="row mt-2 rounded row-cols-12" id="orders_table">


                <div class="col-12 col-md mt-1 me-2 pt-3 bg-body rounded rounded-3">
                    <ul class="nav nav-tabs nav-fill " id="navTabs1_tabs" role="tablist">
                        <li class="nav-item flex-shrink-1 fw-bold">

                            <a class="nav-link active flex-shrink-1" id="navTabs1_1_tab_2" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_1_2" role="tab" aria-controls="navTabs1_1" aria-selected="true" wappler-command="editContent"><i class="fas fa-list-ol" style="margin-right: 3px;"></i>

                                {{trans.data.orders[lang.value]}}
                            </a>
                        </li>
                        <li class="nav-item flex-shrink-1 fw-bold">
                            <a class="nav-link" id="navTabs1_2_tab_2" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_2_2" role="tab" aria-controls="navTabs1_2" aria-selected="false" wappler-command="editContent"><i class="fas fa-hand-holding-usd" style="margin-right: 3px;"></i>
                                {{trans.data.credit[lang.value]}}</a>
                        </li>
                        <li class="nav-item flex-shrink-1 fw-bold">
                            <a class="nav-link" id="navTabs1_2_tab_1" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_2_1" role="tab" aria-controls="navTabs1_2" aria-selected="false" wappler-command="editContent"><i class="far fa-chart-bar" style="margin-right: 3px;"></i>{{trans.data.shiftReport[lang.value]}}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link flex-shrink-1 fw-bold" id="navTabs1_2_tab_3" data-bs-toggle="tab" href="#" data-bs-target="#navTabs1_2_3" role="tab" aria-controls="navTabs1_2" aria-selected="false" wappler-command="editContent"><i class="fas fa-exclamation-triangle" style="margin-right: 5px;"></i>{{trans.data.lowStock[lang.value]}} <sup id="readyItems" dmx-text="list_low_stock.data.custom_get_stock_alerts.count()" class="sup-text text-danger" style="font-size:15px;"></sup></a>
                        </li>
                    </ul>
                    <div class="tab-content" id="navTabs1_content">
                                        ...
                                        <table class="table table-hover table-sm table-borderless" id="cashierorders">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="t_table" wappler-command="editContent">{{trans.data.asset[lang.value]}}</th>
                                                    <th class="t_table" wappler-command="editContent">{{trans.data.customer[lang.value]}}</th>
                                                    <th class="t_waiter" wappler-command="editContent">{{trans.data.waiter[lang.value]}}</th>
                                                    <th class="t_status text-center" wappler-command="editContent">{{trans.data.status[lang.value]}}</th>
                                            ...
                                            <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_orders_all_shift.data.query" id="tableRepeat5">
                                                <tr class="fw-bold text-body">
                                                    ...
                                                    <td wappler-command="editContent">
                                                        <h6 dmx-text="trans.data.getValueOrKey(order_status)[lang.value]" dmx-class:yellow-state="(order_status == 'Ordered')" dmx-class:green-state="(order_status == 'Paid')" dmx-class:grey-state="(order_status == 'Pending')" dmx-class:red-state="(order_status == 'Credit')" class="text-center pt-1 pb-1 ps-2 pe-2 fw-bold">Fancy display heading</h6>
                                                    </td>
                                                    <td wappler-empty="undefined" wappler-command="editContent" class="text-center">
                                                        <button id="btn22" class="btn text-primary" data-bs-target="#productInfo" dmx-on:click="session_variables.remove('current_order');session_variables.set('current_order',order_id);readItemModal.show();read_item_order.load({order_id: order_id})" dmx-bind:value="list_orders.data.query[0].order_id" wappler-empty="Editable" wappler-command="editContent" style="/* color: #ff84ff !important */"><i class="far fa-edit fa-sm"><br></i></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="tab-pane fade scrollable" id="navTabs1_2_1" role="tabpanel" aria-labelledby="navTabs1_2_tab_1">
                            <div class="row justify-content-xxl-center mt-2 pt-3 pb-2 ps-2 pe-2 bg-light">
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="mt-2 col-xxl-auto col-auto">
                                            <div class="d-flex">
                                                <h4 dmx-text="trans.data.total[lang.value]+': '+SalesReportShift.data.product_report.sum(`Total`).formatNumber('0',',',',')" class="me-3 fw-bold text-light"></h4>
                                                <h4 dmx-text="trans.data.volume[lang.value]+': '+SalesReportShift.data.product_report.sum(`Volume`).formatNumber('0',',',',')" class="fw-bold text-light">{{trans.data.volume[lang.value]}}:</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                        ...
                                                        <table class="table table-sm">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th wappler-command="editContent">{{trans.data.category[lang.value]}}</th>
                                                                    <th wappler-command="editContent">{{trans.data.volume[lang.value]}}</th>
                                                                    <th wappler-command="editContent">{{trans.data.total[lang.value]}}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="SalesReportShift.data.product_report" id="tableRepeat2">
                                                                <tr>
                                                                    ...
                                                                    <td dmx-text="product_category_name" wappler-command="editContent"></td>
                                                                    <td dmx-text="Volume" wappler-command="editContent"></td>
                                                                    <td dmx-text="(Total).toNumber().formatNumber('0',',',',')" wappler-command="editContent"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                            ...
                            <div class="row mt-3 justify-content-xxl-center rounded rounded-3 scrollable-y pt-md-2">
                                <div class="col-md-6 text-xxl-center col-lg-auto col-auto scrollable rounded rounded-3 ms-2 pt-1 pb-1 ps-1 pe-1 bg-secondary">

                                    <h4 class="text-center" wappler-command="editContent">{{trans.data.sales[lang.value]}}</h4>
                            ...
                            <div class="row mt-3 row-cols-12 justify-content-between">
                                ...
                                <div class="text-xxl-center rounded rounded-3 col-xxl col-md-12 ms-2 pt-1 pb-1 ps-1 pe-1 bg-secondary">

                                    <h4 class="text-center" wappler-command="editContent">{{trans.data.categories[lang.value]}}</h4>
                            ...
                            <div class="row mt-xxl-2 mt-2">
                                <div class="col-md-6 text-xxl-center rounded rounded-3 col ms-2 pt-2 bg-secondary">
                                    <h4 class="text-xxl-center" wappler-command="editContent">{{trans.data.payments[lang.value]}}</h4>
                            ...
                            <div class="row mt-xxl-2 mt-2 row-cols-12 rounded rounded-3 scrollable-y row-cols-md-12">
                                <div class="col-md col-md-4 text-xxl-center rounded rounded-3 col-xl-5 col-12 d-flex col-xxl-7 ms-2 pt-2 pb-2 ps-2 pe-2 bg-secondary">
                                    ...
                                    <h4 class="text-center text-xxl-center" wappler-command="editContent">{{trans.data.salesMonitor[lang.value]}}</h4>
                                                ...
                                                <table class="table table-hover table-sm">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th wappler-command="editContent">{{trans.data.department[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.Ordered[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.Processing[lang.value]}}</th>
                                                            ...
                                                            <th wappler-command="editContent">{{trans.data.note[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.execution[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.dateTime[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.customer[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.status[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.asset[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.service[lang.value]}}</th>
                                                            <th wappler-command="editContent">{{trans.data.category[lang.value]}}</th>
                                                    ...
                                                    <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="product_report_shift_department_admin.data.product_report" id="tableRepeat8">
                                                        <tr dmx-class:group-main="(order_item_group_type)=='Main'" dmx-class:group-accessory="(order_item_group_type)=='Accessory'">
                                                            ...
                                                            <td dmx-text="trans.data.getValueOrKey(order_item_status)[lang.value]" wappler-command="editContent" dmx-class:order-paid="(order_item_status == 'Delivered')" dmx-class:order-ordered="(order_item_status == 'Processing')" dmx-class:order-credit="(order_item_status)=='Ordered'"></td>
                                                            <td dmx-text="order_id" wappler-command="editContent"></td>
                                                            <td dmx-text="department_name" wappler-command="editContent"></td>
                                                            <td dmx-text="order_time_ordered" wappler-command="editContent"></td>
                                                            <td dmx-text="order_time_processing" wappler-command="editContent"></td>
                                                            ...
                                                            <td dmx-text="order_item_notes" wappler-command="editContent"></td>
                                                            <td dmx-text="user_prepared" wappler-command="editContent"></td>
                                                            <td dmx-text="order_time" wappler-command="editContent"></td>
                                                            <td dmx-text="customer_first_name+' '+customer_last_name" wappler-command="editContent"></td>
                                                            <td dmx-text="order_status" wappler-command="editContent"></td>
                                                            <td dmx-text="table_name" wappler-command="editContent"></td>
                                                            <td dmx-text="service_name" wappler-command="editContent"></td>
                                                            <td dmx-text="product_category_name" wappler-command="editContent"></td>
                                                            <td dmx-text="user_username" wappler-command="editContent"></td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-sm">
                                            <thead>
                                                <tr>
                                                    <th wappler-command="editContent">{{trans.data.product[lang.value]}}</th>
                                                    <th wappler-command="editContent">{{trans.data.minStock[lang.value]}}</th>
                                                    <th wappler-command="editContent">{{trans.data.inStock[lang.value]}}</th>
                                                </tr>
                                            </thead>
                                            <tbody is="dmx-repeat" dmx-generator="bs5table" dmx-bind:repeat="list_low_stock.data.custom_get_stock_alerts" id="tableRepeat6">
                                                <tr>
                                                    <td dmx-text="product_name" wappler-command="editContent"></td>
                                                    <td dmx-text="product_min_stock" wappler-command="editContent"></td>
                                                    <td dmx-text="TotalStock" wappler-command="editContent"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                <div class="rounded col-12 col-md col-md-4 mt-1 bg-secondary">
    ...
    <script>
        $(document).ready(
    $("td:contains('Ordered')").each(function(){var word = $(this).text(); word = word.replace('Ordered', 'Commandé'); $(this).text(word);}));
